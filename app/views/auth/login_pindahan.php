		...
		<div class="wrapper full-page-wrapper page-auth page-login text-center" style="min-height:100%">
			<div class="inner-page">
				<div class="login-box center-block">
					...
					<div class="text-center" style="margin-top:30px; font-weight:bold">
						Mulai hari senin 25 Maret 2024, Presensi sudah menggunakan Server sekolah, Presensi dapat di akses menggunakan link :
					</div>

					<div class="text-center" style="color:dodgerblue; font-weight:bold; font-size:20px; margin-top:20px; margin-bottom:20px">
						<a href="http://presensi.smktelkom-bjb.sch.id/">http://presensi.smktelkom-bjb.sch.id/</a>
					</div>

					<div class="text-center">
						<span style="font-weight:bold; color:red">Perhatikan :</span>
						<br />
						<div style="margin-top:3px; font-size:20px; font-weight:bold; font-family:calibri">
							Gunakan <span style="color:blue">http</span> jangan <span style="color:red">https</span> (tanpa "s")<br />
						</div>
					</div>

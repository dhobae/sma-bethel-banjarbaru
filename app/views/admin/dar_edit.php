...
<div class="card card-primary card-outline" style="margin-top:10px;">
   <div class="card-body box-profile">
      ...
      <form action="<?= URLROOT; ?>/admin/DAR_edit" method="POST" enctype="multipart/form-data">
         ...
         <ul>
            ...
            ?>
               ...
               <li><?= $k->nama ?> (<?= $k->nik ?>) <a href="<?= URLROOT; ?>/admin/deleteAdminDAR/<?php echo $data['admin']->id . '-' . $k->nik ?>"> &nbsp;&nbsp;<b><span style="color:red">Hapus</span></b></a></li>
            <?php
            }
            ?>
         </ul>
         ...
         <div class="form-group row">
            <div class="col-sm-10">
               ...
               <?php if ($_SESSION['role'] == 'admin') { ?>
                  <a href="<?= URLROOT; ?>/admin/DAR_edit" class="btn btn-danger btn-sm"><i class="fa fa-undo"></i> &nbsp;Kembali</a>
               <?php } else { ?>
                  <a href="<?= URLROOT; ?>/admin/DAR_edit" class="btn btn-danger btn-sm"><i class="fa fa-undo"></i> &nbsp;Kembali</a>
               <?php } ?>
            </div>

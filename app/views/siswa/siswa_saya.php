            ...
            <table class="table tabel4">
               ...
               <tbody>
                  ...
                  if ($data['kelas_saya']) {
                     ...
                     <tr>
                        <td colspan="14" style="text-align:center; vertical-align:middle; height:100px">
                           <b>Belum ada presensi kelas hari ini</b>
                        </td>
                     </tr>
                  <?php } ?>
               </tbody>
...
<script>
   ...
   function submitForm() {
      ...
      window.location.href = '<?= URLROOT ?>/siswa/kelas_saya?tanggal=' + tanggal;
   }
</script>

...
<div class="card card-primary card-outline" style="margin-top:10px;">
   <div class="card-body box-profile">
      ...
      <div class="huruf1 tengah" style="font-size:20px; font-weight:bold">
         Data Siswa SMA Bethel Banjarbaru
      </div>
   </div>
</div>
      ...
      <div class="row">
         <div class="col">
            <div class="float-right">
               <a href="<?= URLROOT ?>/siswa/edit_saya" class="btn btn-primary btn-sm tombol2" title="Simpan data"><i class="fa fa-edit"></i> &nbsp;Edit Profil</a>
            </div>
         </div>
      </div>

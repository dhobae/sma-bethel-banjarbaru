...
<div class="card" style="margin-top: 10px; background-color:cornsilk">
   ...
   <div class="card-body box-profile">
      ...
      <?php
      $diff_all = 0;
      //foreach ($data['rekap_jam_kerja_nik'] as $field_all) {
      //   if ($data['rekap_jam_kerja']) {
      //      $diff_all  = $field_all->Seconds_all;
      //   } else {
      //      $diff_all  = 0;
      //   }
      //}
      ...
      <table class="table tabel3 table-striped" id="example3">
         <thead style="background-color:brown; color:white">
            <tr>
               ...
               <th rowspan="2">NIK/NIP</th>
               <th rowspan="2">Nama Dosen / Karyawan</th>
               <th colspan="3" style="text-align:center;">Beban Kerja</td>
         ...
         <tbody>
            ...
            ?>
                  <tr>
                     ...
                     <td style="width:150px;" class="tengah"> <?= $field->nik ?> </td>
                     <td> <?= $field->nama ?> </td>
                     <td style="text-align:center;"> <?= $hari_kerja ?></td>
                     <td style="text-align:center;"> <?= $jam_kerja ?></td>
                     <td style="text-align:center;"> <?= $tjam ?></td>

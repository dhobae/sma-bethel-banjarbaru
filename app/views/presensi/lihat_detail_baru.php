...
?>
<?php
$year = date($_GET['tahun']);
$month = date($_GET['bulan']);
...
<div class="card" style="margin-top: 10px; background-color:azure">
   ...
   <div class="card-body">
      <div style="margin-top: -10px !important;">
         <a href="<?= URLROOT ?>/presensi/rekap_jam_kerja?bulan=<?= $month ?>&tahun=<?= $year ?>&submit=" class="btn btn-danger btn-sm" title="Kembali ke halaman sebelumnya tomboldua"><i class="fa fa-undo"></i> &nbsp;Kembali</a>
      </div>

      <div class="text-center mb-4">
         <span style="font-size:28px; font-weight:bold">
            <?= $data['ambil_nama']->nama ?>
         </span>
      </div>
      ...
      <div class="table-responsive">
         <table class="tabeltiga table-bordered table-striped" style="font-weight:bold">
            <thead style="background-color:brown; color:white">
               <tr>
                  ...
                  <th colspan=2 style="height:30px">Presensi Masuk</th>
               ...
               ?>
                  ...
                  <tr>
                     ...
                     if (($hari == "Sabtu") || ($hari == "Minggu")) {
                        ...
                        echo "<td colspan='9' style='text-align:center;background:#757676;'> Libur Akhir Pekan </td>";
                     } else {
                     ?>
                           ...
                           foreach ($rekap_bulanan as $field2) {
                              if ($field2->nik == "all") {
                                 ...
                                 if (($field2->status_masuk == 'Izin') or ($field2->status_masuk == 'Cuti') or ($field2->status_masuk == 'TL') or ($field2->status_masuk == 'Sakit') or ($field2->status_masuk == 'Libur')) {
                                    ...
                                    $beban_waktu = ke_time($beban);
                                    $istirahat_waktu = ke_time($istirahat);
                                    ...
                                    echo "<td class='text-center'>" . $istirahat_waktu . " Jam </td>";
                                    echo "<td class='text-center'>" . $beban_waktu . " Jam </td>";
                                    ...
                                    if ($diff < 0) {
                                       ...
                                       echo "<td class='text-center'>" . $jam . ':' . sprintf('%02d', floor($menit / 60)) . " Jam</td>";
                                    }
                                    $total = $total + $diff;
                                 }
                              }
...
<?php
function ke_time($decimal_time)
{
   $jam = floor($decimal_time);
   $menit = ($decimal_time - $jam) * 60;

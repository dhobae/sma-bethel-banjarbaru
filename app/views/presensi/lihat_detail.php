            ...
            <table class="tabeltiga table-bordered table-striped">
                <thead style="background-color:brown; color:white">
                    <tr>
                        ...
                        <th style="width: 90px;" rowspan=2>Hari</th>
                        <th rowspan=2>Tanggal</th>
                        <th style="width: 95px;" rowspan=2>Presensi</th>
                        <th colspan=2>Presensi Masuk</th>
                        <th colspan=2>Presensi Pulang</th>
                        <th rowspan=2 style="width: 110px;">Lama</th>
                    </tr>
                    <tr>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            if (($hari == "Sabtu") || ($hari == "Minggu")) {
                                ...
                                echo "<td colspan=6 style='text-align:center;background:#757676;'> Libur Akhir Pekan </td>";
                            } else {
                            ?>
                            ...
                            <?php
                                ...
                                if ($rekap_bulanan) :
                                    foreach ($rekap_bulanan as $field2) {
                                        if ($field2->nik == "all") {
                                            echo "<td colspan=6 style='text-align:center;background:#A7A7A7;'>" . $field2->keterangan_libur . "</td>";

      ...
      <div class="mb-2">
         ...
         if ($_SESSION['role'] == 'admin') { ?>
            <div style="margin-top:-15px;">
               <a href="<?= URLROOT ?>/presensi/tambah_libur" class="btn btn-primary btn-sm tombol3"><i class="fa fa-plus-square"></i>&nbsp; Tambah/Isi hari Libur </a>
            </div>
         <?php } ?>
      </div>
         ...
         <table class="tabeltiga table-bordered table-striped" id="example">
            <thead>
               <tr>
                  ...
                  <th style="width:190px;">Mulai dari</th>
                  <th style="width:190px;">Sampai dengan</th>
            ...
            <tbody>
               ...
               ?>
                     <tr>
                        ...
                        if ($_SESSION['role'] == 'admin') { ?>
                           <td>
                              <a href="javascript:void(0)" onclick="edit()" style="color:blue; font-weight:bold;"> Edit</a>
                              |
                              <a href="javascript:void(0)" onclick="hapus('<?= $field->id ?>')" style="color:blue; font-weight:bold;"> Delete</a>
                           </td>
                        <?php } ?>
                     </tr>
                  <?php
...
<script>
   function hapus(id) {
      console.log('URL: ' + '<?= URLROOT ?>/presensi/hapus_libur/' + id);
      Swal.fire({
         ...
         if (result.isConfirmed) {
            $.ajax({
               url: '<?= URLROOT ?>/presensi/hapus_libur/' + id,
               type: 'GET',
               dataType: 'json',
   ...
   function edit() {
      Swal.fire({
         ...
         text: "Hapus hari libur dan tambahkan kembali hari libur yang benar",
         icon: "warning"
      });
   }
</script>
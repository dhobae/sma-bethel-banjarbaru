...
if ($_SESSION['role'] != 'admin') {
   if (isset($_SESSION['password_change_required']) && $_SESSION['password_change_required'] === true) {
      ...
      echo 'Swal.fire({
               icon: "question",
               title: "Respon Anda",
               text: "Apakah aplikasi ini tetap dilanjutkan atau tidak perlu dilanjutkan?.",
               confirmButtonText: "Isi Respon",
               confirmButtonColor: "#ff0000"
            }).then(function() {
               window.location.href = "backup/pendapat_saya";
            });';
      echo '</script>';
...
<!-- SELAIN HP ----------------------- -->
<!--
<div class="row d-none d-md-block d-lg-block" style="margin-top:0px">
   <div class="col">
      <div class="card card-danger card-outline">
         <div class="card-body box-profile text-center blinking" style="padding:7px">
            Aplikasi Presensi ini dalam masa uji coba, <span style="font-weight:bold; color:red">status WFO dan WFH akan bakal sering terjadi kesalahan</span>, dikarenakan pembacaan IP masih belum dari Device bapak/ibu, saat sudah bukan dalam masa uji lagi maka pembacaan status WFO dan WFH akan sepenuhnya akan sesuai
         </div>
      </div>
   </div>
</div>
   ...
   <div class="col">
      <div class="card card-danger card-outline">
         <div class="card-body box-profile text-center blinking" style="padding:7px">
            <b>
               <?php
               $setuju = $data['polling']->setuju;
               $dengan_catatan = $data['polling']->dengan_catatan;
               $tidak_setuju = $data['polling']->tidak_setuju;

               $setuju1 = ($setuju / ($setuju + $dengan_catatan + $tidak_setuju)) * 100;
               $dengan_catatan1 = ($dengan_catatan / ($setuju + $dengan_catatan + $tidak_setuju)) * 100;
               $tidak_setuju1 = ($tidak_setuju / ($setuju + $dengan_catatan + $tidak_setuju)) * 100;
               ?>
               Hasil sementara dari pertanyaan "Apakah Aplikasi ini dilanjutkan?"<br />
               <div style="font-size:16px">
                  Tidak Perlu &nbsp;:&nbsp;
                  <span style="color:red; font-size:30px"><?= number_format($tidak_setuju1, 0) ?>%</span>
                  &nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;
                  Dengan Catatan &nbsp;:&nbsp;
                  <span style="color:red; font-size:30px"><?= number_format($dengan_catatan1, 0) ?>%</span>
                  &nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;
                  Lanjutkan &nbsp;:&nbsp;
                  <span style="color:red; font-size:30px"><?= number_format($setuju1, 0) ?>%</span>
               </div>
            </b>
         </div>
      </div>
...
<!-- HANYA DI HP ------------------- -->
<!--
<div class="row d-block d-md-none" style="margin-top:0px">
   <div class="col">
      <div class="card card-danger card-outline">
         <div class="card-body box-profile text-center blinking" style="padding:7px; font-size:0.9em">
            Aplikasi Presensi ini dalam masa uji coba, <span style="font-weight:bold; color:red">status WFO dan WFH akan bakal sering terjadi kesalahan</span>, dikarenakan pembacaan IP masih belum dari Device bapak/ibu, saat sudah bukan dalam masa uji lagi maka pembacaan status WFO dan WFH akan sepenuhnya akan sesuai
         </div>
      </div>
   </div>
      ...
      <div class="card card-danger card-outline">
         <div class="card-body box-profile text-center blinking" style="padding:7px; font-size:0.9em">
            <b>
               ...
               <div class="row mb-1">
                  <div class="col">
                     Hasil sementara pertanyan<br />"Apakah Aplikasi ini dilanjutkan?"
                  </div>
               </div>
...
$beban_kerja = $data['beban_kerja']->hari_kerja * $data['beban_kerja']->jam_kerja;
$jam1 = floor($total / (60 * 60));
$persen = ($jam1 / $beban_kerja) * 100;
?>

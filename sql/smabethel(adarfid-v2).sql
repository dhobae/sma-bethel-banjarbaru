...
--
-- Host: localhost:3306
-- Generation Time: Feb 23, 2026 at 12:41 AM
...
CREATE TABLE `absen` (
  ...
  `status_masuk` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `from_masuk` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `jam_pulang` time DEFAULT NULL,
  `status_pulang` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `from_pulang` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `keterangan` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `loc_masuk` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `loc_pulang` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `visitid` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `visitid_pulang` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
...
INSERT INTO `absen` (`id`, `nik`, `tanggal`, `jam_masuk`, `status_masuk`, `from_masuk`, `jam_pulang`, `status_pulang`, `from_pulang`, `keterangan`, `loc_masuk`, `loc_pulang`, `created_at`, `updated_at`, `visitid`, `visitid_pulang`) VALUES
(3, '17760062', '2026-01-06', '11:12:39', 'Hadir', 'WFO', '11:18:00', 'Pulang', 'WFO', '-', '', '', '2026-01-06 03:17:39', '2026-01-06 03:17:39', '333e45cc264a1ee5b109aecd3ee8883e', '333e45cc264a1ee5b109aecd3ee8883e'),
(4, '21960012', '2026-01-06', '11:50:04', 'Hadir', 'WFH', '00:00:00', '-', '-', '-', '', '-', '2026-01-06 03:55:04', '2026-01-06 03:55:04', '9e1d8e55ea913b0f93cbd070c6161305', NULL),
(12, '5750012', '2026-01-05', '07:18:01', 'Hadir', 'WFO', '16:00:49', 'Pulang', 'WFO', 'Absen masuk via RFID | Absen pulang via RFID', NULL, NULL, '2026-01-04 23:18:01', '2026-01-04 23:18:01', NULL, NULL),
(14, '1700024', '2026-01-06', '07:09:34', 'Hadir', 'WFO', NULL, NULL, NULL, 'Absen masuk via RFID', NULL, NULL, '2026-01-05 23:09:34', '2026-01-05 23:09:34', NULL, NULL),
(15, '21910007', '2026-02-10', '07:30:00', 'Hadir', 'WFO', NULL, NULL, NULL, 'Absen masuk via RFID', NULL, NULL, '2026-02-09 23:30:00', '2026-02-09 23:30:00', NULL, NULL),
(16, '19880023', '2026-02-10', '07:30:11', 'Hadir', 'WFO', NULL, NULL, NULL, 'Absen masuk via RFID (Terlambat)', NULL, NULL, '2026-02-09 23:30:11', '2026-02-09 23:30:11', NULL, NULL),
(17, '17760062', '2026-02-10', '07:30:20', 'Hadir', 'WFO', NULL, NULL, NULL, 'Absen masuk via RFID (Terlambat)', NULL, NULL, '2026-02-09 23:30:20', '2026-02-09 23:30:20', NULL, NULL),
(18, '16930033', '2026-02-10', '07:30:27', 'Hadir', 'WFO', NULL, NULL, NULL, 'Absen masuk via RFID (Terlambat)', NULL, NULL, '2026-02-09 23:30:27', '2026-02-09 23:30:27', NULL, NULL),
(19, '20950021', '2026-02-10', '07:30:37', 'Hadir', 'WFO', NULL, NULL, NULL, 'Absen masuk via RFID (Terlambat)', NULL, NULL, '2026-02-09 23:30:37', '2026-02-09 23:30:37', NULL, NULL),
(20, '15910037', '2026-02-10', '07:30:51', 'Hadir', 'WFO', NULL, NULL, NULL, 'Absen masuk via RFID (Terlambat)', NULL, NULL, '2026-02-09 23:30:51', '2026-02-09 23:30:51', NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `absen_harian_siswa`
--

CREATE TABLE `absen_harian_siswa` (
  `id_ahs` int NOT NULL,
  `nis_ahs` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tgl_ahs` date DEFAULT NULL,
  `status_ahs` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Hadir, Alpa, Izin, Sakit, Libur',
  `jam_masuk_ahs` time DEFAULT NULL,
  `jam_pulang_ahs` time DEFAULT NULL,
  `id_libur` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `kelas_ahs` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `wali_kelas_ahs` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_jadwal_setting_ahs` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `absen_harian_siswa`
--
...
(3, '252366', '2026-02-10', 'Hadir', '07:31:17', NULL, NULL, NULL, NULL, NULL),
(4, '242350', '2026-02-10', 'Hadir', '07:31:27', NULL, NULL, NULL, NULL, NULL),
(5, '252363', '2026-02-10', 'Izin', '07:30:00', NULL, '0', 'XA', '19680002', 1),
(6, '252363', '2026-02-11', 'Izin', '07:30:00', NULL, '0', 'XA', '19680002', 1),
(7, '232330', '2026-02-23', 'Hadir', '07:00:44', NULL, NULL, NULL, NULL, NULL),
(8, '232331', '2026-02-23', 'Hadir', '07:00:53', NULL, NULL, NULL, NULL, NULL),
(9, '232335', '2026-02-23', 'Hadir', '07:01:02', NULL, NULL, NULL, NULL, NULL),
(10, '232321', '2026-02-23', 'Hadir', '07:01:11', NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `absen_izin`
--

CREATE TABLE `absen_izin` (
  `id_izin` int NOT NULL,
  `nik_izin` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tgl_izin` date DEFAULT NULL,
  `kelas_izin` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ruang_izin` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jam_izin` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mata_pelajaran_pendek` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mata_pelajaran` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jenis_izin` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `alasan_izin` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `file_materi` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `absen_kelas` (
  ...
  `nik_absen_kelas` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tgl_absen_kelas` date DEFAULT NULL,
  `kelas_absen_kelas` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ruang_absen_kelas` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jam_absen_kelas` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mata_pelajaran` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mata_pelajaran_lengkap` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `materi_pelajaran` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `wali_kelas_absen` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Table structure for table `absen_kelas_siswa`
--

CREATE TABLE `absen_kelas_siswa` (
  `id_aks` int NOT NULL,
  `tgl_aks` date DEFAULT NULL,
  `nis_aks` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `kelas_aks` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `wali_kelas_aks` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_jam1` varchar(9) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `absen_jam1` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_jam2` varchar(9) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `absen_jam2` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_jam3` varchar(9) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `absen_jam3` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_jam4` varchar(9) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `absen_jam4` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_jam5` varchar(9) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `absen_jam5` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_jam6` varchar(9) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `absen_jam6` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_jam7` varchar(9) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `absen_jam7` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_jam8` varchar(9) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `absen_jam8` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_jam9` varchar(9) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `absen_jam9` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_jam10` varchar(9) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `absen_jam10` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_jam11` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `absen_jam11` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `admin` (
  `id` int NOT NULL,
  `hak_akses` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nama_admin` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nip_pegawai` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(2, 'prodi', 'Kepala Prodi', '19680002'),
(3, 'wali_kelas', 'Wali Kelas', '19680002,99730061,21960012,7650033'),
(4, 'hci', 'HCI', NULL),
(5, 'keuangan', 'Keuangan', NULL),
(6, 'lab', 'Kaur IT', NULL),
(8, 'kurikulum', 'Kurikulum', '17760062'),
(9, 'satpam', 'Satpam', '990707'),
(10, 'cs', 'CS', NULL),
(11, 'dar', 'Daily Activity Report', NULL),
(12, 'duplikat', 'Device Absen', '15730001');
...
CREATE TABLE `catatan_wali_kelas` (
  ...
  `id_jadwal_setting` int NOT NULL COMMENT 'Referensi ke periode/semester',
  `id_siswa` int NOT NULL,
  `catatan` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Catatan wali kelas',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO `catatan_wali_kelas` (`id_catatan`, `id_jadwal_setting`, `id_siswa`, `catatan`, `created_at`, `updated_at`) VALUES
(1, 1, 10, '', '2026-01-03 02:56:05', '2026-01-03 03:02:04'),
(7, 1, 11, '', '2026-01-03 03:02:32', '2026-01-03 03:02:32'),
(8, 2, 21, '', '2026-02-06 00:36:23', '2026-02-06 00:36:23');
...
CREATE TABLE `dar` (
  `id_dar` int NOT NULL,
  `nik_dar` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tanggal_dar` date DEFAULT NULL,
  `isi_dar` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `ekstrakurikuler` (
  ...
  `id_jadwal_setting` int NOT NULL COMMENT 'Referensi ke periode/semester',
  `id_siswa` int NOT NULL,
  `nama_ekstrakurikuler` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Nama kegiatan ekstrakurikuler',
  `nilai` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Baik/Cukup/Kurang atau A/B/C',
  `keterangan` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT 'Deskripsi/catatan kegiatan',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `ekstrakurikuler` (`id_ekstrakurikuler`, `id_jadwal_setting`, `id_siswa`, `nama_ekstrakurikuler`, `nilai`, `keterangan`, `created_at`, `updated_at`) VALUES
(11, 1, 10, 'adawdwaw', 'Baik', 'dawdwa', '2026-01-03 03:02:04', '2026-01-03 03:02:04'),
(12, 1, 10, 'dadawadaw', 'Cukup', 'awdaw', '2026-01-03 03:02:04', '2026-01-03 03:02:04');
...
INSERT INTO `ip_address` (`id`, `ip_address`, `keterangan`) VALUES
(14, '192.168.40.0/24', 'Admin 1'),
(15, '192.168.80.0/24', 'Admin 2'),
(17, '192.168.200.0/24', 'Server Admin dan Guru'),
(18, '192.168.100.0/24', 'Guru'),
(19, '180.241.191.88', 'tes'),
(22, '100.100.100.0/24', 'Server CCTV'),
(23, '36.75.56.240/24', 'stmik'),
(26, '10.0.10.250/24', 'stmik2'),
(27, '36.82.250.0/24', 'tes 2'),
(28, '114.10.143.0/24', 'tes'),
(30, '192.168.1.4/24', 'Testing Local'),
(31, '10.220.251.136', '');
...
CREATE TABLE `izin` (
  ...
  `status_izin` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `keterangan_izin` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `izin_keluar_jam_kerja`
--
...
--
-- Table structure for table `izin_mengajar`
--

CREATE TABLE `izin_mengajar` (
  `id_izin` int NOT NULL,
  `nik` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tanggal_awal` date DEFAULT NULL,
  `tanggal_akhir` date DEFAULT NULL,
  `acc` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'Belum' COMMENT 'Sudah atau Belum',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Table structure for table `izin_mengajar_transaksi`
--

CREATE TABLE `izin_mengajar_transaksi` (
  `id_transaksi` int NOT NULL,
  `id_izin_transaksi` int DEFAULT NULL,
  `kelas` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mata_pelajaran` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status_izin` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'izin, sakit, cuti, TL',
  `alasan_izin` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `materi` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `izin_siswa` (
  `id_izin` int NOT NULL,
  `nis_izin` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `kelas_izin` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `wali_kelas_izin` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jenis_izin` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Izin, Sakit',
  `mulai_izin` date DEFAULT NULL,
  `sampai_izin` date DEFAULT NULL,
  `tgl_dibuat_izin` date DEFAULT NULL,
  `alasan_izin` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `file_izin` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status_izin` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Menunggu ACC, Disetujui, Ditolak',
  `nik_status_izin` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `izin_siswa` (`id_izin`, `nis_izin`, `kelas_izin`, `wali_kelas_izin`, `jenis_izin`, `mulai_izin`, `sampai_izin`, `tgl_dibuat_izin`, `alasan_izin`, `file_izin`, `status_izin`, `nik_status_izin`) VALUES
(1, '252363', 'XA', '19680002', 'Sakit', '2026-02-10', '2026-02-11', '2026-02-10', '', 'izin_698a6fd21f1053.38574409.pdf', 'Disetujui', '19680002');
...
CREATE TABLE `jadwal` (
  `id` int NOT NULL,
  `kelas` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ruang` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `jadwal_lengkap` (
  ...
  `kode_kelas` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `kelas` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ruang` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `wali_kelas` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `prodi` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mp1` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `guru1` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mp2` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `guru2` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mp3` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `guru3` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mp4` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `guru4` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mp5` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `guru5` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mp6` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `guru6` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mp7` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `guru7` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mp8` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `guru8` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mp9` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `guru9` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mp10` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `guru10` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `validasi` int DEFAULT NULL COMMENT '0 belum, 1 sudah',
  `validasi_oleh` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `jadwal_lengkap` (`id_jadwal_lengkap`, `hari`, `kode_kelas`, `kelas`, `ruang`, `wali_kelas`, `prodi`, `mp1`, `guru1`, `mp2`, `guru2`, `mp3`, `guru3`, `mp4`, `guru4`, `mp5`, `guru5`, `mp6`, `guru6`, `mp7`, `guru7`, `mp8`, `guru8`, `mp9`, `guru9`, `mp10`, `guru10`, `validasi`, `validasi_oleh`, `tanggal_validasi`, `berlaku_jadwal_dari`, `created_at`, `updated_at`) VALUES
(1, 'Senin', 'XA', 'X', 'A', '19680002', 'SMABETHEL', '167', NULL, '155', '15910037', '153', '19880023', '145', '7650033', '145', '18890141', '159', '18850125', '143', '99000004', '159', '19680002', '151', '20950021', '159', '21960012', 1, '17760062', '2026-02-10', '2000-01-01', '2026-02-09 17:09:40', '2026-02-09 17:09:40'),
(2, 'Selasa', 'XA', 'X', 'A', '19680002', 'SMABETHEL', '151', '17760062', '141', '20950021', '158', '21990009', '151', '22000002', '155', '16930033', '158', '18890141', '155', '18970009', '141', '15910037', '141', '16930033', '141', '19680002', 1, '17760062', '2026-02-10', '2000-01-01', '2026-02-09 17:09:40', '2026-02-09 17:09:40'),
(3, 'Rabu', 'XA', 'X', 'A', '19680002', 'SMABETHEL', '144', '21910007', '154', '99000004', '146', '15910037', '144', '18970009', '147', '18850125', '154', '22000002', '159', '21990009', '160', '21910007', '144', '99000004', '149', '99730061', 1, '17760062', '2026-02-10', '2000-01-01', '2026-02-09 17:09:41', '2026-02-09 17:09:41'),
(4, 'Kamis', 'XA', 'X', 'A', '19680002', 'SMABETHEL', '153', '15910037', '142', '21990009', '145', '16930033', '151', '18970009', '155', '21960012', '149', '20950021', '146', '18850124', '147', '17760062', '148', '17760062', '143', '99000004', 1, '17760062', '2026-02-10', '2000-01-01', '2026-02-09 17:09:41', '2026-02-09 17:09:41'),
(5, 'Jumat', 'XA', 'X', 'A', '19680002', 'SMABETHEL', '168', NULL, '152', '18970009', '141', '15730001', '143', '21910007', '144', '18850125', '150', '17760062', '160', '21910007', '159', '21910007', '143', '21960012', '143', '21990009', 1, '17760062', '2026-02-10', '2000-01-01', '2026-02-09 17:09:41', '2026-02-09 17:09:41'),
(6, 'Senin', 'XIA', 'XI', 'A', '99730061', 'SMABETHEL', '167', NULL, '149', '19880023', '145', '21960012', '146', '19680002', '152', '99730061', '144', '7650033', '153', '17760062', '144', '16930033', '144', '18850124', '142', '18850125', 1, '1700024', '2026-02-10', '2000-01-01', '2026-02-09 17:09:41', '2026-02-09 17:09:41'),
(7, 'Selasa', 'XIA', 'XI', 'A', '99730061', 'SMABETHEL', '148', '15910037', '145', '18850124', '151', '18850124', '144', '16930033', '149', '15910037', '150', '99730061', '145', '21990009', '160', '18890141', '155', '19880023', '154', '20950021', 1, '1700024', '2026-02-10', '2000-01-01', '2026-02-09 17:09:41', '2026-02-09 17:09:41'),
(8, 'Rabu', 'XIA', 'XI', 'A', '99730061', 'SMABETHEL', '148', '22000002', '151', '19680002', '144', '21960012', '150', '15910037', '148', '16930033', '146', '7650033', '154', '21910007', '158', '20950021', '157', '18890141', '151', '18850125', 1, '1700024', '2026-02-10', '2000-01-01', '2026-02-09 17:09:41', '2026-02-09 17:09:41'),
(9, 'Kamis', 'XIA', 'XI', 'A', '99730061', 'SMABETHEL', '143', '99730061', '159', '18850124', '150', '99730061', '148', '20950021', '141', '7650033', '154', '7650033', '151', '16930033', '157', '21990009', '150', '22000002', '148', '99730061', 1, '1700024', '2026-02-10', '2000-01-01', '2026-02-09 17:09:41', '2026-02-09 17:09:41'),
(10, 'Jumat', 'XIA', 'XI', 'A', '99730061', 'SMABETHEL', '168', NULL, '146', '19880023', '143', '18850124', '146', '19880023', '148', '19880023', '152', '21960012', '145', '16930033', '142', '18850125', '149', '21910007', '142', '18890141', 1, '1700024', '2026-02-10', '2000-01-01', '2026-02-09 17:09:41', '2026-02-09 17:09:41'),
(11, 'Senin', 'XIIA', 'XII', 'A', '21960012', 'SMABETHEL', '167', NULL, '142', '18970009', '156', '19680002', '154', '18850125', '150', '22000002', '142', '18890141', '158', '22000002', '150', '99000004', '148', '19880023', '144', '18890141', 1, '1700024', '2026-02-10', '2000-01-01', '2026-02-09 17:09:41', '2026-02-09 17:09:41'),
(12, 'Selasa', 'XIIA', 'XII', 'A', '21960012', 'SMABETHEL', '144', '18970009', '154', '7650033', '142', '19880023', '143', '19680002', '141', '17760062', '154', '18850124', '160', '15730001', '157', '7650033', '142', '18850124', '156', '15730001', 1, '1700024', '2026-02-10', '2000-01-01', '2026-02-09 17:09:41', '2026-02-09 17:09:41'),
(13, 'Rabu', 'XIIA', 'XII', 'A', '21960012', 'SMABETHEL', '144', '18970009', '156', '20950021', '155', '22000002', '150', '19680002', '155', '99730061', '152', '21990009', '151', '18850124', '158', '15730001', '146', '7650033', '143', '21960012', 1, '1700024', '2026-02-10', '2000-01-01', '2026-02-09 17:09:41', '2026-02-09 17:09:41'),
(14, 'Kamis', 'XIIA', 'XII', 'A', '21960012', 'SMABETHEL', '151', '22000002', '158', '99000004', '156', '21960012', '156', '17760062', '143', '99730061', '147', '99000004', '155', '20950021', '145', '16930033', '155', '20950021', '160', '15730001', 1, '1700024', '2026-02-10', '2000-01-01', '2026-02-09 17:09:41', '2026-02-09 17:09:41'),
(15, 'Jumat', 'XIIA', 'XII', 'A', '21960012', 'SMABETHEL', '168', NULL, '158', '20950021', '147', '21910007', '149', '22000002', '151', '21990009', '141', '19880023', '144', '15730001', '155', '18850124', '141', '15910037', '159', '15910037', 1, '1700024', '2026-02-10', '2000-01-01', '2026-02-09 17:09:41', '2026-02-09 17:09:41'),
(16, 'Senin', 'XIIB', 'XII', 'B', '7650033', 'SMABETHEL', '167', NULL, '157', '99730061', '158', '15730001', '159', '21910007', '160', '17760062', '142', '15730001', '156', '99730061', '156', '21960012', '159', '19680002', '151', '18850124', 1, '1700024', '2026-02-10', '2000-01-01', '2026-02-09 17:09:41', '2026-02-09 17:09:41'),
(17, 'Selasa', 'XIIB', 'XII', 'B', '7650033', 'SMABETHEL', '141', '19880023', '160', '16930033', '155', '99000004', '142', '18850125', '157', '18970009', '151', '15910037', '143', '18850125', '149', '18970009', '142', '99000004', '147', '22000002', 1, '1700024', '2026-02-10', '2000-01-01', '2026-02-09 17:09:41', '2026-02-09 17:09:41'),
(18, 'Rabu', 'XIIB', 'XII', 'B', '7650033', 'SMABETHEL', '143', '99000004', '146', '21990009', '142', '7650033', '154', '17760062', '156', '7650033', '150', '18890141', '149', '19680002', '148', '18890141', '151', '22000002', '143', '7650033', 1, '1700024', '2026-02-10', '2000-01-01', '2026-02-09 17:09:41', '2026-02-09 17:09:41'),
(19, 'Kamis', 'XIIB', 'XII', 'B', '7650033', 'SMABETHEL', '147', '21910007', '159', '18890141', '147', '18970009', '143', '21960012', '144', '18850125', '158', '19680002', '151', '15730001', '144', '15730001', '147', '18850125', '154', '17760062', 1, '1700024', '2026-02-10', '2000-01-01', '2026-02-09 17:09:41', '2026-02-09 17:09:41'),
(20, 'Jumat', 'XIIB', 'XII', 'B', '7650033', 'SMABETHEL', '168', NULL, '157', '15730001', '148', '18970009', '151', '21990009', '148', '20950021', '159', '21910007', '154', '15910037', '141', '21960012', '159', '99000004', '153', '17760062', 1, '1700024', '2026-02-10', '2000-01-01', '2026-02-09 17:09:41', '2026-02-09 17:09:41'),
(21, 'Senin', 'XA', 'X', 'A', '19680002', 'SMABETHEL', '167', NULL, '159', '17760062', '149', '21960012', '156', '99730061', '156', '21960012', '141', '18850124', '142', '21990009', '157', '15730001', '150', '18850124', '146', '99730061', 1, '1700024', '2026-02-10', '2026-02-10', '2026-02-09 23:35:17', '2026-02-09 23:35:17'),
(22, 'Selasa', 'XA', 'X', 'A', '19680002', 'SMABETHEL', '158', '17760062', '143', '21910007', '148', '18850124', '157', '19880023', '152', '19680002', '148', '17760062', '157', '18890141', '148', '21910007', '142', '19680002', '154', '19880023', 1, '1700024', '2026-02-10', '2026-02-10', '2026-02-09 23:35:17', '2026-02-09 23:35:17'),
(23, 'Rabu', 'XA', 'X', 'A', '19680002', 'SMABETHEL', '149', '16930033', '148', '18970009', '141', '22000002', '148', '17760062', '152', '18850124', '154', '22000002', '144', '18890141', '146', '15730001', '157', '7650033', '152', '21910007', 1, '1700024', '2026-02-10', '2026-02-10', '2026-02-09 23:35:17', '2026-02-09 23:35:17'),
(24, 'Kamis', 'XA', 'X', 'A', '19680002', 'SMABETHEL', '158', '18890141', '142', '18970009', '143', '19680002', '149', '22000002', '156', '21990009', '150', '19880023', '147', '19880023', '160', '15730001', '142', '16930033', '160', '18850124', 1, '1700024', '2026-02-10', '2026-02-10', '2026-02-09 23:35:17', '2026-02-09 23:35:17'),
(25, 'Jumat', 'XA', 'X', 'A', '19680002', 'SMABETHEL', '168', NULL, '160', '15910037', '150', '21960012', '158', '20950021', '154', '15730001', '146', '16930033', '144', '21990009', '151', '99730061', '144', '18890141', '156', '20950021', 1, '1700024', '2026-02-10', '2026-02-10', '2026-02-09 23:35:17', '2026-02-09 23:35:17'),
(26, 'Senin', 'XIA', 'XI', 'A', '99730061', 'SMABETHEL', '167', NULL, '143', '19880023', '157', '99730061', '156', '7650033', '144', '15910037', '155', '18850125', '157', '18890141', '141', '7650033', '148', '15910037', '143', '18850124', 1, '1700024', '2026-02-10', '2026-02-10', '2026-02-09 23:35:17', '2026-02-09 23:35:17'),
(27, 'Selasa', 'XIA', 'XI', 'A', '99730061', 'SMABETHEL', '156', '22000002', '156', '7650033', '147', '19880023', '143', '21910007', '142', '15910037', '141', '21960012', '147', '16930033', '157', '18850125', '151', '21960012', '152', '99000004', 1, '1700024', '2026-02-10', '2026-02-10', '2026-02-09 23:35:17', '2026-02-09 23:35:17'),
(28, 'Rabu', 'XIA', 'XI', 'A', '99730061', 'SMABETHEL', '144', '19680002', '156', '99000004', '157', '19680002', '143', '18890141', '154', '15910037', '147', '21990009', '142', '21910007', '155', '18970009', '143', '18970009', '141', '19680002', 1, '1700024', '2026-02-10', '2026-02-10', '2026-02-09 23:35:17', '2026-02-09 23:35:17'),
(29, 'Kamis', 'XIA', 'XI', 'A', '99730061', 'SMABETHEL', '144', '21960012', '159', '99000004', '141', '21990009', '141', '17760062', '154', '99000004', '160', '15910037', '151', '21960012', '141', '18970009', '157', '15910037', '148', '18850125', 1, '1700024', '2026-02-10', '2026-02-10', '2026-02-09 23:35:17', '2026-02-09 23:35:17'),
(30, 'Jumat', 'XIA', 'XI', 'A', '99730061', 'SMABETHEL', '168', NULL, '159', '18850125', '142', '16930033', '147', '18890141', '160', '16930033', '148', '18970009', '155', '15730001', '141', '21910007', '152', '19880023', '142', '15910037', 1, '1700024', '2026-02-10', '2026-02-10', '2026-02-09 23:35:17', '2026-02-09 23:35:17'),
(31, 'Senin', 'XIIA', 'XII', 'A', '21960012', 'SMABETHEL', '167', NULL, '146', '99730061', '148', '20950021', '148', '99000004', '158', '15730001', '157', '19680002', '150', '20950021', '156', '19880023', '143', '18970009', '155', '21960012', 1, '1700024', '2026-02-10', '2026-02-10', '2026-02-09 23:35:17', '2026-02-09 23:35:17'),
(32, 'Selasa', 'XIIA', 'XII', 'A', '21960012', 'SMABETHEL', '149', '21910007', '153', '18850125', '144', '20950021', '146', '7650033', '144', '20950021', '155', '21990009', '144', '19680002', '160', '21960012', '156', '15910037', '151', '18850124', 1, '1700024', '2026-02-10', '2026-02-10', '2026-02-09 23:35:17', '2026-02-09 23:35:17'),
(33, 'Rabu', 'XIIA', 'XII', 'A', '21960012', 'SMABETHEL', '153', '21910007', '142', '22000002', '144', '21910007', '159', '99730061', '151', '17760062', '155', '18850124', '145', '99730061', '158', '99000004', '153', '99000004', '159', '22000002', 1, '1700024', '2026-02-10', '2026-02-10', '2026-02-09 23:35:17', '2026-02-09 23:35:17'),
(34, 'Kamis', 'XIIA', 'XII', 'A', '21960012', 'SMABETHEL', '157', '18850124', '159', '22000002', '159', '7650033', '142', '99730061', '153', '22000002', '156', '19680002', '143', '18890141', '151', '22000002', '158', '19880023', '152', '18890141', 1, '1700024', '2026-02-10', '2026-02-10', '2026-02-09 23:35:17', '2026-02-09 23:35:17'),
(35, 'Jumat', 'XIIA', 'XII', 'A', '21960012', 'SMABETHEL', '168', NULL, '150', '7650033', '145', '20950021', '151', '99000004', '145', '21910007', '150', '99000004', '157', '19680002', '141', '22000002', '160', '17760062', '143', '18890141', 1, '1700024', '2026-02-10', '2026-02-10', '2026-02-09 23:35:17', '2026-02-09 23:35:17'),
(36, 'Senin', 'XIIB', 'XII', 'B', '7650033', 'SMABETHEL', '167', NULL, '145', '21990009', '147', '15910037', '153', '21990009', '154', '18890141', '159', '99730061', '143', '99000004', '141', '15910037', '160', '21910007', '142', '18970009', 1, '1700024', '2026-02-10', '2026-02-10', '2026-02-09 23:35:17', '2026-02-09 23:35:17'),
(37, 'Selasa', 'XIIB', 'XII', 'B', '7650033', 'SMABETHEL', '146', '16930033', '155', '16930033', '156', '21960012', '145', '16930033', '149', '18970009', '150', '7650033', '142', '17760062', '148', '17760062', '147', '18850124', '159', '15730001', 1, '1700024', '2026-02-10', '2026-02-10', '2026-02-09 23:35:17', '2026-02-09 23:35:17'),
(38, 'Rabu', 'XIIB', 'XII', 'B', '7650033', 'SMABETHEL', '156', '18850125', '147', '17760062', '160', '99730061', '153', '16930033', '148', '18890141', '147', '18970009', '157', '19880023', '150', '7650033', '153', '21960012', '153', '20950021', 1, '1700024', '2026-02-10', '2026-02-10', '2026-02-09 23:35:17', '2026-02-09 23:35:17'),
(39, 'Kamis', 'XIIB', 'XII', 'B', '7650033', 'SMABETHEL', '148', '20950021', '141', '7650033', '145', '19880023', '156', '16930033', '147', '7650033', '159', '21990009', '142', '22000002', '143', '19680002', '158', '99000004', '159', '22000002', 1, '1700024', '2026-02-10', '2026-02-10', '2026-02-09 23:35:17', '2026-02-09 23:35:17'),
(40, 'Jumat', 'XIIB', 'XII', 'B', '7650033', 'SMABETHEL', '168', NULL, '151', '17760062', '142', '19680002', '151', '18850125', '145', '18850124', '158', '20950021', '159', '99730061', '153', '16930033', '148', '7650033', '143', '18970009', 1, '1700024', '2026-02-10', '2026-02-10', '2026-02-09 23:35:17', '2026-02-09 23:35:17');
...
CREATE TABLE `jadwal_setting` (
  ...
  `blok` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(1, 1, 'Ganjil', 'I', '2026-02-10', '2026-02-10', 1),
(2, 2, 'Genap', 'II', '2027-02-11', '2026-02-09', 0),
(3, 3, 'Ganjil', 'I', '2028-02-02', '2026-02-09', 0),
(4, 4, 'Genap', 'II', '2030-01-01', '2026-02-09', 0),
(5, 5, 'Ganjil', 'I', '2005-01-01', '2026-02-09', 0),
(6, 6, 'Genap', 'II', '2019-07-03', '2026-02-09', 0),
(7, 1, 'Genap', 'II', '2026-03-02', '2026-02-10', 0),
(8, 7, 'Ganjil', 'I', '2000-01-01', '2026-02-10', 0);
...
CREATE TABLE `kantor` (
  ...
  `loc_kantor` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `libur` (
  ...
  `tanggal_mulai` date NOT NULL,
  `tanggal_akhir` date NOT NULL,
  `keterangan_libur` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `libur` (`id`, `tanggal_mulai`, `tanggal_akhir`, `keterangan_libur`) VALUES
(1, '2024-01-01', '2024-01-01', 'Libur Tahun Baru'),
(2, '2024-02-07', '2024-02-07', 'Libur Agenda sekolah '),
(3, '2024-02-08', '2024-02-08', 'Isra MIkraj Nabi muhammad SAW'),
(5, '2024-03-11', '2024-03-11', 'Hari  Suci Nyepi'),
(7, '2024-03-31', '2024-03-31', 'Hari Paskah'),
(8, '2024-04-08', '2024-04-08', 'cuti bersama hari raya idul fitri 1445 hijrah'),
(9, '2024-04-09', '2024-04-09', 'cuti bersama hari raya idul fitri 1445 hijrah'),
(10, '2024-04-10', '2024-04-11', 'Hari raya idul Fitri 1445 Hijrah'),
(11, '2024-04-12', '2024-04-12', 'cuti bersama hari raya idul fitri 1445 hijrah'),
(12, '2024-05-01', '2024-05-01', 'Hari buruh nasional'),
(13, '2024-05-09', '2024-05-09', 'Kenaikan isa al masih'),
(15, '2024-05-23', '2024-05-23', 'Hari Raya Waisak 2568 BE'),
(16, '2024-05-24', '2024-05-24', 'cuti bersama hari raya  waisak'),
(20, '2024-06-17', '2024-06-17', 'Hari raya idul adha 1445 Hijrah'),
(21, '2024-09-16', '2024-09-16', 'Mauliad Nabi Muhammad SAW'),
(22, '2024-12-25', '2024-12-25', 'Hari Raqya Natal'),
(23, '2024-12-26', '2024-12-26', 'Cuti Bersama Hari Raya Natal'),
(24, '2024-03-29', '2024-03-29', 'Wafat Isa Al Masih'),
(25, '2024-02-09', '2024-02-09', 'Libur Agenda sekolah'),
(26, '2024-02-14', '2024-02-14', 'HARI PEMUNGUTAN SUARA PEMILIHAN UMUM TAHUN 2024 '),
(28, '2024-02-01', '2024-02-01', 'Uji Coba Aplikasi'),
(29, '2024-03-12', '2024-03-12', 'CUTI BERSAMA'),
(30, '2024-04-15', '2024-04-15', 'cuti bersama hari raya idul fitri 1445 hijrah'),
(31, '2024-05-10', '2024-05-10', 'cuti bersama kenaikan isa almasih'),
(33, '2024-06-18', '2024-06-18', 'cuti bersama hari raya idul adha 1445 hijrah'),
(34, '2024-11-27', '2024-11-27', 'HARI PILKADA ( LIBUR NASIONAL)'),
(35, '2025-01-01', '2025-01-01', 'TAHUN BARU '),
(36, '2025-01-27', '2025-01-27', 'ISRA MIKRAJ NABI MUHAMMAD SAW'),
(37, '2025-01-29', '2025-01-29', 'Tahun Baru Imlek 2576 Kongzili '),
(38, '2025-01-28', '2025-01-28', 'Tahun Baru Imlek 2576 Kongzili (CUTI BERSAMA)'),
(39, '2025-03-28', '2025-03-28', 'Hari Suci Nyepi (Tahun Baru  Saka 1947) CT BERSAMA'),
(40, '2025-03-31', '2025-04-01', 'Idul Fitri 1446 Hijriah'),
(41, '2025-04-02', '2025-04-07', 'CUTI BERSAMA (Idul Fitri 1446 Hijriah )'),
(42, '2025-04-18', '2025-04-18', 'Wafat Yesus Kristus'),
(43, '2025-04-20', '2025-04-20', 'Kebangkitan Yesus Kristus (Paskah) '),
(44, '2025-05-01', '2025-05-01', 'Hari Buruh Internasional '),
(45, '2025-05-12', '2025-05-12', 'Hari Raya Waisak 2569 BE '),
(46, '2025-05-13', '2025-05-13', 'CUTI BERSAMA (Hari Raya Waisak 2569 BE)'),
(47, '2025-05-29', '2025-05-29', 'Kenaikan Yesus Kristus '),
(48, '2025-05-30', '2025-05-30', 'Kenaikan Yesus Kristus ( CUTI BERSAMA)'),
(49, '2025-06-01', '2025-06-01', 'Hari Lahir Pancasila '),
(50, '2025-06-06', '2025-06-06', 'Idul Adha 1446 Hijriah'),
(51, '2025-06-09', '2025-06-09', 'Idul Adha 1446 Hijriah(CUTI BERSAMA)'),
(52, '2025-06-27', '2025-06-27', '1 Muharam Tahun Baru Islam 1447 Hijriah'),
(53, '2025-08-17', '2025-08-17', 'Proklamasi Kemerdekaan '),
(54, '2025-09-05', '2025-09-05', 'Maulid Nabi Muhammad S.A.W '),
(55, '2025-12-25', '2025-12-25', 'Kelahiran Yesus Kristus '),
(56, '2025-12-26', '2025-12-26', 'Kelahiran Yesus Kristus (CUTI BERSAMA)');
...
(4, '2025-10-01', 23, '7.5', '07:30:00', '16:00:00', '07:30:00', '16:00:00', '1.0', '07:30:00', '16:00:00', '07:30:00', '16:00:00', '7.5', '1.0');
...
CREATE TABLE `m_pelajaran` (
  ...
  `mata_pelajaran` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `singkatan` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `prodi` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(141, 'Pendidikan Kewarganegaraan', 'PKN', 'SMABETHEL', '2025-10-17 03:14:05', '2025-10-17 03:14:05'),
(142, 'Bahasa Indonesia', 'BIND', 'SMABETHEL', '2025-10-17 03:14:21', '2025-10-17 03:14:21'),
(143, 'Bahasa Inggris', 'BING', 'SMABETHEL', '2025-10-17 03:14:32', '2025-10-17 03:14:32'),
(144, 'Pendidikan Jasmani, Olahraga, dan Kesehatan', 'PJOK', 'SMABETHEL', '2025-10-17 03:14:46', '2025-10-17 03:14:46'),
(145, 'Kimia', 'Kimia', 'SMABETHEL', '2025-10-17 03:14:53', '2025-10-17 03:14:53'),
(146, 'Sosiologi', 'Sos', 'SMABETHEL', '2025-10-17 03:14:59', '2025-10-17 03:14:59'),
(147, 'Pendalaman Alkitab', 'PAlkitab', 'SMABETHEL', '2025-10-17 03:15:16', '2025-10-17 03:15:16'),
(148, 'Matematika', 'MTK', 'SMABETHEL', '2025-10-17 03:15:30', '2025-10-17 03:15:30'),
(149, 'Biologi', 'BIO', 'SMABETHEL', '2025-10-17 03:16:26', '2025-10-17 03:16:26'),
(150, 'Geografi', 'GEO', 'SMABETHEL', '2025-10-17 03:16:48', '2025-10-17 03:16:48'),
(151, 'Sejarah', 'Sejarah', 'SMABETHEL', '2025-10-17 03:17:11', '2025-10-17 03:17:11'),
(152, 'Sejarah Indonesia', 'SejIndo', 'SMABETHEL', '2025-10-17 03:17:23', '2025-10-17 03:17:23'),
(153, 'Informatika', 'Informatik', 'SMABETHEL', '2025-10-17 03:17:31', '2025-10-17 03:17:31'),
(154, 'Pendidikan Agama Kristen', 'PAK', 'SMABETHEL', '2025-10-17 03:17:40', '2025-10-17 03:17:40'),
(155, 'Ekonomi', 'EKO', 'SMABETHEL', '2025-10-17 03:17:47', '2025-10-17 03:17:47'),
(156, 'Seni Budaya', 'SENBUD', 'SMABETHEL', '2025-10-17 03:17:56', '2025-10-17 03:17:56'),
(157, 'Prakarya', 'Prakarya', 'SMABETHEL', '2025-10-17 03:18:49', '2025-10-17 03:18:49'),
(158, 'Pendidikan Kewirausahaan', 'PKWU', 'SMABETHEL', '2025-10-17 03:18:59', '2025-10-17 03:18:59'),
(159, 'Fisika', 'Fisika', 'SMABETHEL', '2025-10-17 03:19:11', '2025-10-17 03:19:11'),
(160, 'Bimbingan Konseling', 'BK', 'SMABETHEL', '2025-10-17 03:19:55', '2025-10-17 03:19:55'),
(167, 'UPACARA', 'UPA', 'SMABETHEL', '2026-02-09 16:40:55', '2026-02-09 16:40:55'),
(168, 'IBADAH/JUMAT BERSIH', 'IBD', 'SMABETHEL', '2026-02-09 16:40:55', '2026-02-09 16:40:55');
...
CREATE TABLE `m_prodi` (
  ...
  `nama_prodi` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ketua_prodi` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status_prodi` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Aktif atau Tidak',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'SMABETHEL', 'SMABETHEL', '19680002', 'Aktif', '2025-10-16 15:34:12', '2025-10-16 15:34:12');
...
INSERT INTO `m_tahun_ajaran` (`id_tahun_ajaran`, `tahun_ajaran`, `status`) VALUES
(1, '2026/2027', 1),
(2, '2027/2028', 0),
(3, '2028/2029', 0),
(4, '2030/2031', 0),
...
CREATE TABLE `nilai_pelajaran` (
  `id_nilai_pelajaran` int NOT NULL,
  `id_jadwal_setting` int NOT NULL COMMENT 'Referensi ke periode/semester',
  `id_siswa` int NOT NULL COMMENT 'Referensi ke siswa',
  `id_pelajaran` int NOT NULL COMMENT 'Referensi ke mata pelajaran',
  `nilai` decimal(5,2) DEFAULT NULL COMMENT 'Nilai final (0-100)',
  `predikat` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'A/B/C/D',
  `deskripsi` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT 'Deskripsi capaian kompetensi',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `nilai_pelajaran` (`id_nilai_pelajaran`, `id_jadwal_setting`, `id_siswa`, `id_pelajaran`, `nilai`, `predikat`, `deskripsi`, `created_at`, `updated_at`) VALUES
(1, 1, 10, 142, '80.00', 'B', NULL, '2026-01-03 02:56:05', '2026-01-03 03:02:04'),
(5, 1, 10, 149, '70.00', 'C', NULL, '2026-01-03 03:01:29', '2026-01-03 03:02:04'),
(6, 1, 10, 155, '80.00', 'B', NULL, '2026-01-03 03:01:29', '2026-01-03 03:02:04'),
(7, 1, 10, 159, '80.00', 'B', NULL, '2026-01-03 03:01:29', '2026-01-03 03:02:04'),
(8, 1, 10, 150, '90.00', 'A', NULL, '2026-01-03 03:01:29', '2026-01-03 03:02:04'),
(9, 1, 10, 153, '90.00', 'A', NULL, '2026-01-03 03:01:29', '2026-01-03 03:02:04'),
(10, 1, 10, 145, '90.00', 'A', NULL, '2026-01-03 03:01:29', '2026-01-03 03:02:04'),
(11, 1, 10, 148, '90.00', 'A', NULL, '2026-01-03 03:01:29', '2026-01-03 03:02:04'),
(12, 1, 10, 147, '90.00', 'A', NULL, '2026-01-03 03:01:29', '2026-01-03 03:02:04'),
(13, 1, 10, 154, '90.00', 'A', NULL, '2026-01-03 03:01:29', '2026-01-03 03:02:04'),
(14, 1, 10, 144, '90.00', 'A', NULL, '2026-01-03 03:01:29', '2026-01-03 03:02:04'),
(15, 1, 10, 157, '90.00', 'A', NULL, '2026-01-03 03:01:29', '2026-01-03 03:02:04'),
(16, 1, 10, 151, '90.00', 'A', NULL, '2026-01-03 03:01:29', '2026-01-03 03:02:04'),
(17, 1, 10, 152, '90.00', 'A', NULL, '2026-01-03 03:01:29', '2026-01-03 03:02:04'),
(18, 1, 10, 156, '90.00', 'A', NULL, '2026-01-03 03:01:29', '2026-01-03 03:02:04'),
(19, 1, 10, 146, '90.00', 'A', NULL, '2026-01-03 03:01:29', '2026-01-03 03:02:04'),
(51, 1, 11, 142, '22.00', 'D', NULL, '2026-01-03 03:02:32', '2026-01-03 03:02:32'),
(52, 2, 21, 142, '22.00', 'D', NULL, '2026-02-06 00:36:23', '2026-02-06 00:36:23');
...
CREATE TABLE `nilai_sikap` (
  ...
  `id_jadwal_setting` int NOT NULL COMMENT 'Referensi ke periode/semester',
  `id_siswa` int NOT NULL,
  `predikat_spiritual` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'SB/B/C/K (Sangat Baik/Baik/Cukup/Kurang)',
  `deskripsi_spiritual` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT 'Deskripsi sikap spiritual',
  `predikat_sosial` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'SB/B/C/K',
  `deskripsi_sosial` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT 'Deskripsi sikap sosial',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `nilai_sikap` (`id_nilai_sikap`, `id_jadwal_setting`, `id_siswa`, `predikat_spiritual`, `deskripsi_spiritual`, `predikat_sosial`, `deskripsi_sosial`, `created_at`, `updated_at`) VALUES
(1, 1, 10, 'SB', 'awdasd', 'B', 'awdwad', '2026-01-03 02:56:05', '2026-01-03 03:02:04'),
(7, 1, 11, '', '', '', '', '2026-01-03 03:02:32', '2026-01-03 03:02:32'),
(8, 2, 21, '', '', '', '', '2026-02-06 00:36:23', '2026-02-06 00:36:23');
...
CREATE TABLE `notif` (
  ...
  `text` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `isi_tombol` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `warna_tombol` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `background` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `warna_title` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `warna_konten` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `notif` (`id_notif`, `status_notif`, `icon`, `title`, `text`, `isi_tombol`, `warna_tombol`, `background`, `warna_title`, `warna_konten`) VALUES
(1, 0, 'info', 'Notifikasi WhatsApp', 'Silahkan tentukan apakah ingin mendapat Notif WhatsApp atau tidak di menu Notifikasi WA', 'Ok, saya mengerti', '#00cc29', '#cc0000', '#ffffff', '#ffffff');
...
CREATE TABLE `pegawai` (
  ...
  `rfid` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `password__` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `telegram` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nama` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `kode` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jabatan` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mengajar` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `full_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jk` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `agama` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nomor_hp` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `notif_wa` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'Tidak',
  ...
  `absen` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `urutan` int DEFAULT NULL,
  `avatar` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dar` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'Tidak' COMMENT 'Ya, Tidak',
...
(1, '5750012', '5750012', '3358800586', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'Elliansi Esmaun', 'MAUN', 'TU', 'Tidak', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'SMA', '-', '-', 'Aktif', 80, NULL, 'Tidak', 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(3, '22000002', '22000002', '3358285690', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'Kurniah Amalia, S.PAK', 'KUR', 'Guru', 'Ya', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'S1', '-', '-', 'Aktif', 100, NULL, 'Tidak', 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(4, '21960012', '21960012', '2395151511', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'Ari Ratna sari, S.Pd', 'RAT', 'Guru', 'Ya', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'S1', '-', '-', 'Aktif', 80, NULL, 'Tidak', 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(5, '21990009', '21990009', '3362517866', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'Tommy Bayu Susanto, S.Kom', 'BAY', 'Guru', 'Ya', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'S1', '-', '-', 'Aktif', 100, NULL, 'Tidak', 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(6, '18850125', '18850125', '3358374634', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'Letty Kriszeni, M.Th', 'TY', 'Guru', 'Ya', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'S1', '-', '-', 'Aktif', 80, NULL, 'Tidak', 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(7, '18850124', '18850124', '3364844410', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'Misyewin Bawi, S.Pd', 'WI', 'Guru', 'Ya', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'S1', '-', '-', 'Aktif', 80, NULL, 'Tidak', 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(8, '7650033', '7650033', '3360284058', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'M.Fikri, S.Pd', 'FIK', 'Guru', 'Ya', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'S1', '-', '-', 'Aktif', 80, NULL, 'Tidak', 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(9, '18970009', '18970009', '3357936042', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'Fransisco Hendrik Putra , S.E', 'DRIK', 'Guru', 'Ya', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'S1', '-', '-', 'Aktif', 100, NULL, 'Tidak', 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(10, '18890141', '18890141', '3358494650', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'Sukartini , S.Pd', 'KAR', 'Guru', 'Ya', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'S1', '-', '-', 'Aktif', 100, NULL, 'Tidak', 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11, '99730061', '99730061', '3370884330', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'M. Zuhdi Sakuri, S.Si', 'DI', 'Guru', 'Ya', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'S1', '-', '-', 'Aktif', 4, NULL, 'Tidak', 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(12, '21910007', '21910007', '3371704682', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'Martopo Yuwono, S.Pd', 'WON', 'Guru', 'Ya', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'S1', '-', '-', 'Aktif', 100, NULL, 'Tidak', 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(13, '16930033', '16930033', '3358012634', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'Desi Sintia Dewi Simanjuntak, S.Pd', 'DES', 'Guru', 'Ya', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'S1', '-', '-', 'Aktif', 80, NULL, 'Tidak', 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(14, '17760062', '17760062', '3363228490', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'Leluyani, M.Th ', 'YAN', 'Guru', 'Ya', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'S2', '-', '-', 'Aktif', 3, NULL, 'Tidak', 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(15, '19880023', '19880023', '3365361610', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'Ria Handayani, S.Pd', 'RIA', 'Guru', 'Ya', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'S1', '-', '-', 'Aktif', 100, NULL, 'Tidak', 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(16, '19680002', '19680002', '3366303146', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'Norhidayah, S.Pd ', 'YAH', 'Guru', 'Ya', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'S1', '-', '-', 'Aktif', 100, NULL, 'Tidak', 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(17, '15730001', '15730001', '3361291994', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'Amalia Septhyanda , S.Pd', 'LIA', 'Guru', 'Ya', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'S1', '-', '-', 'Aktif', 80, NULL, 'Tidak', 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(18, '15910037', '15910037', '3358830986', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'Kristina Dewi Natalia, S.Pd', 'DEW', 'Guru', 'Ya', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'S1', '-', '-', 'Aktif', 80, NULL, 'Tidak', 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(19, '20950021', '20950021', '3368843898', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'Dimas Dwi Nugroho, S.Psi', 'MAS', 'Guru', 'Ya', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'S1', '-', '-', 'Aktif', 5, NULL, 'Tidak', 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(28, '1700024', '1700024', '3357116330', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'Ichu Yulianty, S.Hut, M.Th', 'CHU', 'KS', 'Tidak', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'S2', '-', '-', 'Aktif', 1, NULL, 'Tidak', 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(45, '11870075', '11870075', '3368966730', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'Supardi', 'PAR', 'TU', 'Tidak', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'SMA', '-', '-', 'Aktif', 80, NULL, 'Tidak', 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(70, '24740003', '24740003', '3361720186', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'Kuril Sigi', 'RIL', 'TP', 'Tidak', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'SMA', '-', '-', 'Aktif', 80, NULL, 'Tidak', 0, NULL, '2024-02-19 05:14:14', '2024-02-19 05:14:14'),
(80, '99000004', '99000004', '2397434759', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'Laili Hayati, S.Pd ', 'LAI', 'Guru', 'Ya', 'Full Time', NULL, NULL, NULL, 'Ya', NULL, NULL, '-', 'S1', '-', '-', 'Aktif', 65, NULL, 'Tidak', 0, NULL, '2024-04-04 06:19:07', '2024-04-04 06:19:07'),
(97, '990707', '990707', NULL, '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', NULL, 'Satpam SMA Bethel', 'SATPAM', 'SA', 'Tidak', 'Full Time', NULL, NULL, NULL, 'Tidak', NULL, NULL, '-', 'SMA', NULL, NULL, 'Aktif', 100, NULL, 'Tidak', 0, NULL, '2025-12-31 07:12:08', '2025-12-31 07:12:08');
...
CREATE TABLE `pendapat` (
  ...
  `nik_pendapat` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pendapat` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `pengunjung` (
  ...
  `npk` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `dari` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `tanggal` date NOT NULL,
  `hits` int NOT NULL,
  `online` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `pengunjung` (`id`, `ip`, `npk`, `dari`, `tanggal`, `hits`, `online`) VALUES
(1, '192.168.1.4', '17760062', 'WFO', '2026-01-03', 1, '1767406277'),
(2, '192.168.1.4', '252358', 'WFO', '2026-01-03', 1, '1767408612'),
(3, '192.168.1.4', '21990009', 'WFO', '2026-01-03', 1, '1767408647'),
(4, '192.168.1.4', '21960012', 'WFO', '2026-01-03', 1, '1767408669'),
(5, '192.168.1.4', '18890141', 'WFO', '2026-01-03', 1, '1767408697'),
(6, '192.168.1.4', '7650033', 'WFO', '2026-01-03', 1, '1767408715'),
(7, '192.168.1.4', '232330', 'WFO', '2026-01-03', 1, '1767408926'),
(8, '192.168.1.4', 'piket', 'WFO', '2026-01-03', 1, '1767409406'),
(9, '192.168.1.4', '21960012', 'WFO', '2026-01-06', 1, '1767671688'),
(10, '::1', '21960012', 'WFH', '2026-01-06', 1, '1767671699'),
(11, '192.168.1.4', 'admin', 'WFO', '2026-01-06', 1, '1767671823'),
(12, '192.168.1.4', 'piket', 'WFO', '2026-01-06', 1, '1767684693'),
(13, '192.168.1.4', 'admin', 'WFO', '2026-01-05', 1, '1767572786'),
(14, '192.168.1.4', 'rfid', 'WFO', '2026-01-05', 1, '1767573773'),
...
(20, '192.168.1.7', 'admin', 'WFO', '2026-01-19', 1, '1768811152'),
(21, '192.168.1.4', 'admin', 'WFH', '2026-02-06', 1, '1770335614'),
(22, '192.168.1.4', '17760062', 'WFH', '2026-02-06', 1, '1770337691'),
(23, '192.168.1.4', '1700024', 'WFH', '2026-02-06', 1, '1770337803'),
(24, '192.168.1.4', '21990009', 'WFH', '2026-02-06', 1, '1770337883'),
(25, '192.168.1.4', '252367', 'WFH', '2026-02-06', 1, '1770338189'),
(26, '192.168.1.4', 'admin', 'WFH', '2026-02-09', 1, '1770630385'),
(27, '192.168.1.4', 'rfid', 'WFH', '2026-02-09', 1, '1770631883'),
(28, '192.168.1.4', '17760062', 'WFH', '2026-02-09', 1, '1770632147'),
(29, '192.168.1.4', '21990009', 'WFO', '2026-02-09', 1, '1770632734'),
(30, '192.168.1.4', '16930033', 'WFO', '2026-02-09', 1, '1770632756'),
(31, '192.168.1.4', '19680002', 'WFO', '2026-02-09', 1, '1770637607'),
(32, '192.168.1.4', '15730001', 'WFO', '2026-02-09', 1, '1770650912'),
(33, '192.168.1.4', 'admin', 'WFO', '2026-02-10', 1, '1770656079'),
(34, '10.220.251.136', 'admin', 'WFH', '2026-02-10', 1, '1770701710'),
(35, '10.220.251.136', '17760062', 'WFO', '2026-02-10', 1, '1770701872'),
(36, '10.220.251.136', 'rfid', 'WFO', '2026-02-10', 1, '1770701899'),
(37, '10.220.251.136', '252363', 'WFO', '2026-02-10', 1, '1770680236'),
(38, '10.220.251.136', '19680002', 'WFO', '2026-02-10', 1, '1770680361'),
(39, '::1', 'rfid', 'WFH', '2026-02-23', 1, '1771800753');
...
CREATE TABLE `prestasi` (
  ...
  `id_jadwal_setting` int NOT NULL COMMENT 'Referensi ke periode/semester',
  `id_siswa` int NOT NULL,
  `jenis_prestasi` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Akademik/Non-Akademik/Olahraga/Seni/Lainnya',
  `nama_prestasi` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Nama lomba/kejuaraan',
  `keterangan` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT 'Keterangan tambahan (tingkat, peringkat, dll)',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `prestasi` (`id_prestasi`, `id_jadwal_setting`, `id_siswa`, `jenis_prestasi`, `nama_prestasi`, `keterangan`, `created_at`, `updated_at`) VALUES
(11, 1, 10, 'Akademik', 'AKAD', 'adwadaw', '2026-01-03 03:02:04', '2026-01-03 03:02:04'),
(12, 1, 10, 'Non-Akademik', 'NON', 'awdawdawaw', '2026-01-03 03:02:04', '2026-01-03 03:02:04');

-- --------------------------------------------------------

--
-- Table structure for table `send_wa`
--

CREATE TABLE `send_wa` (
  `id_send_wa` int NOT NULL,
  `nik_send_wa` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
--
-- Dumping data for table `send_wa`
--

INSERT INTO `send_wa` (`id_send_wa`, `nik_send_wa`, `absen_datang`, `absen_pulang`, `notif_datang`, `notif_pulang`, `created_at`, `updated_at`) VALUES
(1, '1700024', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, '22000002', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(3, '21960012', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(4, '21990009', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(5, '18850125', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(6, '18850124', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(7, '7650033', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(8, '18970009', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(9, '18890141', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(10, '99730061', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(11, '21910007', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(12, '99000004', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(13, '16930033', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(14, '17760062', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(15, '19880023', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(16, '19680002', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(17, '15730001', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(18, '15910037', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(19, '20950021', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(20, '5750012', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(21, '11870075', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(22, '24740003', 0, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
CREATE TABLE `settingan` (
  `id` int NOT NULL,
  `home_dosen` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `kontak` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `settingan` (`id`, `home_dosen`, `kontak`) VALUES
(1, '<p><strong>Informasi Aplikasi :</strong></p>\r\n\r\n<ul>\r\n        <li>Jam datang dengan status <strong>WFO</strong> dan jam pulang status <strong>WFO</strong> tidak terbatas, jam datang dan jam pulang akan tercatat saat melakukan presensi baik jam datang maupun jam pulang.</li>\r\n        <li>Jam datang <strong>WFH</strong> paling cepat jam 07:30 dan jam pulang <strong>WFH</strong> paling lambat jam 16:00, misalkan anda absen datang sebelum jam 07:00 maka secara otomatis akan tercatat menjadi jam 07:30</li>\r\n        <li>Apabila <strong>LUPA</strong> melakukan Presensi pulang <strong>baik WFO maupun WFH</strong>, dan ketika sudah <strong>melawati jam 24:00</strong>, maka pada hari tersebut jam kerja akan tercatat menjadi <strong>0 jam kerja.</strong></li>\r\n</ul>', '<p><strong>Kontak :</strong></p>\r\n\r\n<ul>\r\n        <li><span style=\"font-size: 1rem;\">Selama masa ujicoba aplikasi presensi ini, kalau bapak/ibu ada pertanyaan, silahkan hubungi ulun di WA&nbsp;<br></span><span style=\"font-weight: bolder;\">0857-5082-7477 </span>atau&nbsp;<span style=\"font-size: 1rem; font-weight: 700;\">0857-5066-7547</span></li>\r\n</ul>');
...
CREATE TABLE `siswa` (
  ...
  `prodi` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `kelas_siswa` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ruang_siswa` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jenis_kelamin` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `propinsi` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `kabupaten` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `kecamatan` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nomor_hp` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `nomor_hp_wali` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `status_siswa` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Aktif, Pindah atau Alumni',
  `foto_siswa` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `rfid` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, '232314', 'Aprilliana', 2023, '1', 'XIIA', 'A', 'Perempuan', '0082463819', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3356890442', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(2, '232319', 'Bella kristiana', 2023, '1', 'XIIA', 'A', 'Perempuan', '0085895550', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3369620314', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(3, '232320', 'Cayla Lucia Ramadani', 2023, '1', 'XIIA', 'A', 'Perempuan', '0087439651', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3355767962', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(4, '232321', 'Jekra Agustina Lehu', 2023, '1', 'XIIA', 'A', 'Perempuan', '0082422128', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '2394193831', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(5, '232322', 'Kandini', 2023, '1', 'XIIA', 'A', 'Perempuan', '0074076377', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3359532650', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(6, '232323', 'Kalvin Binhar Yonatan', 2023, '1', 'XIIA', 'A', 'Laki-laki', '0071451746', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3356241626', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(7, '232324', 'Nova Elisa', 2023, '1', 'XIIA', 'A', 'Perempuan', '0084842882', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3368609450', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(8, '232325', 'Risma', 2023, '1', 'XIIA', 'A', 'Perempuan', '0083222872', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '2384091303', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(9, '232327', 'Winda', 2023, '1', 'XIIA', 'A', 'Perempuan', '0064558664', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3358924154', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(10, '232330', 'A. A  Agus Saputra', 2023, '1', 'XIIB', 'B', 'Laki-laki', '0092513747', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3359567578', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(11, '232331', 'Billy Kristian', 2023, '1', 'XIIB', 'B', 'Laki-laki', '0072365563', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3363027626', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(12, '232334', 'Hendri Saputra', 2023, '1', 'XIIB', 'B', 'Laki-laki', '0074142540', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3361851466', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(13, '232335', 'Juan Arnanda', 2023, '1', 'XIIB', 'B', 'Laki-laki', '0088676746', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3370415706', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(14, '232336', 'Maria Klaudia', 2023, '1', 'XIIB', 'B', 'Perempuan', '0074059868', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3360352874', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(15, '232337', 'Nita Ayu', 2023, '1', 'XIIB', 'B', 'Perempuan', '0071991508', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3355979482', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(16, '232338', 'Tribayu Yoyada', 2023, '1', 'XIIB', 'B', 'Laki-laki', '0079548169', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3364037994', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(21, '252367', 'Iskal Munasir', 2025, '1', 'XA', 'A', 'Laki-laki', '0105873200\n', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3356615898', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(22, '252365', 'Desti Flora Andrea', 2025, '1', 'XA', 'A', 'Perempuan', '0097776558\n', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3358149226', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(23, '252364', 'Gloria Paulida', 2025, '1', 'XA', 'A', 'Perempuan', '0037813579\n', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3371564490', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(24, '252363', 'Marsil', 2025, '1', 'XA', 'A', 'Laki-laki', '0103265335\n', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3358625898', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
...
(28, '242354', 'Nikita Felly Hirmandani', 2024, '1', 'XIA', 'A', 'Perempuan', '0092710638', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3363713162', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(29, '252366', 'Yehuda Ferdiansyah', 2024, '1', 'XIA', 'A', 'Laki-laki', '0082601392', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3367325066', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(30, '242352', 'Refli', 2024, '1', 'XIA', 'A', 'Laki-laki', '0081800912', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3357634170', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(31, '242350', 'Melisa', 2024, '1', 'XIA', 'A', 'Perempuan', '0089526035', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '2391091351', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(32, '242349', 'Priskila Novia', 2024, '1', 'XIA', 'A', 'Perempuan', '0086465334', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3368811930', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(33, '242344', 'Richi Kasih Karuniani', 2024, '1', 'XIA', 'A', 'Perempuan', '0092935094', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3366323322', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
...
(35, '242342', 'Andator Ady Putra', 2024, '1', 'XIA', 'A', 'Laki-laki', '0095371217', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '2391061399', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(36, '242355', 'GIDEON ALFREDO ZHERAVINO PUADJOLE', 2024, '1', 'XIA', 'A', 'Laki-laki', '0095618265', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3370199738', '2024-07-08 07:48:20', '2024-07-08 07:48:20'),
(106, '242341', 'Agata Vidia Calbie', 2024, '1', 'XIA', 'A', 'Perempuan', '0092710638', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aktif', NULL, '3368225354', '2024-07-08 07:48:20', '2024-07-08 07:48:20');
...
CREATE TABLE `siswa_hapus` (
  ...
  `tahun_masuk` year DEFAULT NULL,
  `prodi` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `kelas_siswa` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ruang_siswa` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jenis_kelamin` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `NISN` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tempat_lahir` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tanggal_lahir` date DEFAULT NULL,
...
CREATE TABLE `tb_kabupaten` (
  `id_kabupaten` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `id_propinsi_kabupaten` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nama_kabupaten` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `tipe_kabupaten` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tb_kabupaten` (`id_kabupaten`, `id_propinsi_kabupaten`, `nama_kabupaten`, `tipe_kabupaten`) VALUES
('1101', '11', 'Aceh Selatan', 'Kabupaten'),
('1102', '11', 'Aceh Tenggara', 'Kabupaten'),
('1103', '11', 'Aceh Timur', 'Kabupaten'),
('1104', '11', 'Aceh Tengah', 'Kabupaten'),
('1105', '11', 'Aceh Barat', 'Kabupaten'),
('1106', '11', 'Aceh Besar', 'Kabupaten'),
('1107', '11', 'Pidie', 'Kabupaten'),
('1108', '11', 'Aceh Utara', 'Kabupaten'),
('1109', '11', 'Simeulue', 'Kabupaten'),
('1110', '11', 'Aceh Singkil', 'Kabupaten'),
('1111', '11', 'Bireuen', 'Kabupaten'),
('1112', '11', 'Aceh Barat Daya', 'Kabupaten'),
('1113', '11', 'Gayo Lues', 'Kabupaten'),
('1114', '11', 'Aceh Jaya', 'Kabupaten'),
('1115', '11', 'Nagan Raya', 'Kabupaten'),
('1116', '11', 'Aceh Tamiang', 'Kabupaten'),
...
('1201', '12', 'Tapanuli Tengah', 'Kabupaten'),
('1202', '12', 'Tapanuli Utara', 'Kabupaten'),
('1203', '12', 'Tapanuli Selatan', 'Kabupaten'),
('1204', '12', 'Nias', 'Kabupaten'),
('1205', '12', 'Langkat', 'Kabupaten'),
('1206', '12', 'Karo', 'Kabupaten'),
('1207', '12', 'Deli Serdang', 'Kabupaten'),
('1208', '12', 'Simalungun', 'Kabupaten'),
('1209', '12', 'Asahan', 'Kabupaten'),
('1210', '12', 'Labuhanbatu', 'Kabupaten'),
('1211', '12', 'Dairi', 'Kabupaten'),
('1212', '12', 'Toba', 'Kabupaten'),
('1213', '12', 'Mandailing Natal', 'Kabupaten'),
('1214', '12', 'Nias Selatan', 'Kabupaten'),
('1215', '12', 'Pakpak Bharat', 'Kabupaten'),
('1216', '12', 'Humbang Hasundutan', 'Kabupaten'),
...
('1222', '12', 'Labuhanbatu Selatan', 'Kabupaten'),
('1223', '12', 'Labuhanbatu Utara', 'Kabupaten'),
('1224', '12', 'Nias Utara', 'Kabupaten'),
('1225', '12', 'Nias Barat', 'Kabupaten'),
('1271', '12', 'Medan', 'Kota'),
('1272', '12', 'Pematangsiantar', 'Kota'),
('1273', '12', 'Sibolga', 'Kota'),
('1274', '12', 'Tanjung Balai', 'Kota'),
('1275', '12', 'Binjai', 'Kota'),
('1276', '12', 'Tebing Tinggi', 'Kota'),
('1277', '12', 'Padangsidimpuan', 'Kota'),
('1278', '12', 'Gunungsitoli', 'Kota'),
('1301', '13', 'Pesisir Selatan', 'Kabupaten'),
('1302', '13', 'Solok', 'Kabupaten'),
('1303', '13', 'Sijunjung', 'Kabupaten'),
('1304', '13', 'Tanah Datar', 'Kabupaten'),
('1305', '13', 'Padang Pariaman', 'Kabupaten'),
('1306', '13', 'Agam', 'Kabupaten'),
('1307', '13', 'Lima Puluh Kota', 'Kabupaten'),
('1308', '13', 'Pasaman', 'Kabupaten'),
('1309', '13', 'Kepulauan Mentawai', 'Kabupaten'),
('1310', '13', 'Dharmasraya', 'Kabupaten'),
('1311', '13', 'Solok Selatan', 'Kabupaten'),
('1312', '13', 'Pasaman Barat', 'Kabupaten'),
('1371', '13', 'Padang', 'Kota'),
('1372', '13', 'Solok', 'Kota'),
('1373', '13', 'Sawahlunto', 'Kota'),
('1374', '13', 'Padang Panjang', 'Kota'),
('1375', '13', 'Bukittinggi', 'Kota'),
('1376', '13', 'Payakumbuh', 'Kota'),
('1377', '13', 'Pariaman', 'Kota'),
('1401', '14', 'Kampar', 'Kabupaten'),
('1402', '14', 'Indragiri Hulu', 'Kabupaten'),
('1403', '14', 'Bengkalis', 'Kabupaten'),
('1404', '14', 'Indragiri Hilir', 'Kabupaten'),
('1405', '14', 'Pelalawan', 'Kabupaten'),
('1406', '14', 'Rokan Hulu', 'Kabupaten'),
('1407', '14', 'Rokan Hilir', 'Kabupaten'),
('1408', '14', 'Siak', 'Kabupaten'),
('1409', '14', 'Kuantan Singingi', 'Kabupaten'),
...
('1504', '15', 'Batanghari', 'Kabupaten'),
('1505', '15', 'Muaro Jambi', 'Kabupaten'),
('1506', '15', 'Tanjung Jabung Barat', 'Kabupaten'),
('1507', '15', 'Tanjung Jabung Timur', 'Kabupaten'),
('1508', '15', 'Bungo', 'Kabupaten'),
('1509', '15', 'Tebo', 'Kabupaten'),
('1571', '15', 'Jambi', 'Kota'),
...
('1608', '16', 'Ogan Komering Ulu Timur', 'Kabupaten'),
('1609', '16', 'Ogan Komering Ulu Selatan', 'Kabupaten'),
...
('1672', '16', 'Pagar Alam', 'Kota'),
('1673', '16', 'Lubuk Linggau', 'Kota'),
('1674', '16', 'Prabumulih', 'Kota'),
...
('1706', '17', 'Muko Muko', 'Kabupaten'),
('1707', '17', 'Lebong', 'Kabupaten'),
('1708', '17', 'Kepahiang', 'Kabupaten'),
('1709', '17', 'Bengkulu Tengah', 'Kabupaten'),
('1771', '17', 'Bengkulu', 'Kota'),
('1801', '18', 'Lampung Selatan', 'Kabupaten'),
('1802', '18', 'Lampung Tengah', 'Kabupaten'),
('1803', '18', 'Lampung Utara', 'Kabupaten'),
('1804', '18', 'Lampung Barat', 'Kabupaten'),
('1805', '18', 'Tulang Bawang', 'Kabupaten'),
('1806', '18', 'Tanggamus', 'Kabupaten'),
('1807', '18', 'Lampung Timur', 'Kabupaten'),
('1808', '18', 'Way Kanan', 'Kabupaten'),
...
('1903', '19', 'Bangka Selatan', 'Kabupaten'),
('1904', '19', 'Bangka Tengah', 'Kabupaten'),
('1905', '19', 'Bangka Barat', 'Kabupaten'),
('1906', '19', 'Belitung Timur', 'Kabupaten'),
('1971', '19', 'Pangkal Pinang', 'Kota'),
('2101', '21', 'Bintan', 'Kabupaten'),
('2102', '21', 'Karimun', 'Kabupaten'),
...
('3171', '31', 'Jakarta Pusat', 'Kota'),
('3172', '31', 'Jakarta Utara', 'Kota'),
('3173', '31', 'Jakarta Barat', 'Kota'),
('3174', '31', 'Jakarta Selatan', 'Kota'),
('3175', '31', 'Jakarta Timur', 'Kota'),
...
('5272', '52', 'Bima', 'Kota'),
('5301', '53', 'Kupang', 'Kabupaten'),
('5302', '53', 'Timor Tengah Selatan', 'Kabupaten'),
('5303', '53', 'Timor Tengah Utara', 'Kabupaten'),
('5304', '53', 'Belu', 'Kabupaten'),
('5305', '53', 'Alor', 'Kabupaten'),
('5306', '53', 'Flores Timur', 'Kabupaten'),
('5307', '53', 'Sikka', 'Kabupaten'),
('5308', '53', 'Ende', 'Kabupaten'),
('5309', '53', 'Ngada', 'Kabupaten'),
('5310', '53', 'Manggarai', 'Kabupaten'),
('5311', '53', 'Sumba Timur', 'Kabupaten'),
('5312', '53', 'Sumba Barat', 'Kabupaten'),
('5313', '53', 'Lembata', 'Kabupaten'),
('5314', '53', 'Rote Ndao', 'Kabupaten'),
('5315', '53', 'Manggarai Barat', 'Kabupaten'),
('5316', '53', 'Nagekeo', 'Kabupaten'),
('5317', '53', 'Sumba Tengah', 'Kabupaten'),
('5318', '53', 'Sumba Barat Daya', 'Kabupaten'),
('5319', '53', 'Manggarai Timur', 'Kabupaten'),
('5320', '53', 'Sabu Raijua', 'Kabupaten'),
('5321', '53', 'Malaka', 'Kabupaten'),
('5371', '53', 'Kupang', 'Kota'),
...
('6206', '62', 'Katingan', 'Kabupaten'),
('6207', '62', 'Seruyan', 'Kabupaten'),
('6208', '62', 'Sukamara', 'Kabupaten'),
('6209', '62', 'Lamandau', 'Kabupaten'),
('6210', '62', 'Gunung Mas', 'Kabupaten'),
('6211', '62', 'Pulang Pisau', 'Kabupaten'),
('6212', '62', 'Murung Raya', 'Kabupaten'),
('6213', '62', 'Barito Timur', 'Kabupaten'),
('6271', '62', 'Palangkaraya', 'Kota'),
('6301', '63', 'Tanah Laut', 'Kabupaten'),
('6302', '63', 'Kotabaru', 'Kabupaten'),
...
('6402', '64', 'Kutai Kartanegara', 'Kabupaten'),
('6403', '64', 'Berau', 'Kabupaten'),
('6407', '64', 'Kutai Barat', 'Kabupaten'),
('6408', '64', 'Kutai Timur', 'Kabupaten'),
('6409', '64', 'Penajam Paser Utara', 'Kabupaten'),
('6411', '64', 'Mahakam Ulu', 'Kabupaten'),
('6471', '64', 'Balikpapan', 'Kota'),
('6472', '64', 'Samarinda', 'Kota'),
('6474', '64', 'Bontang', 'Kota'),
('6501', '65', 'Bulungan', 'Kabupaten'),
('6502', '65', 'Malinau', 'Kabupaten'),
('6503', '65', 'Nunukan', 'Kabupaten'),
('6504', '65', 'Tana Tidung', 'Kabupaten'),
...
('7107', '71', 'Minahasa Tenggara', 'Kabupaten'),
('7108', '71', 'Bolaang Mongondow Utara', 'Kabupaten'),
('7109', '71', 'Kepulauan Siau Tagulandang Biaro (Sitaro)', 'Kabupaten'),
('7110', '71', 'Bolaang Mongondow Timur', 'Kabupaten'),
('7111', '71', 'Bolaang Mongondow Selatan', 'Kabupaten'),
('7171', '71', 'Manado', 'Kota'),
('7172', '71', 'Bitung', 'Kota'),
...
('7211', '72', 'Banggai Laut', 'Kabupaten'),
('7212', '72', 'Morowali Utara', 'Kabupaten'),
('7271', '72', 'Palu', 'Kota'),
...
('7310', '73', 'Pangkajene Kepulauan', 'Kabupaten'),
...
('7324', '73', 'Luwu Timur', 'Kabupaten'),
('7326', '73', 'Toraja Utara', 'Kabupaten'),
('7371', '73', 'Makassar', 'Kota'),
('7372', '73', 'Pare Pare', 'Kota'),
('7373', '73', 'Palopo', 'Kota'),
('7401', '74', 'Kolaka', 'Kabupaten'),
('7402', '74', 'Konawe', 'Kabupaten'),
('7403', '74', 'Muna', 'Kabupaten'),
('7404', '74', 'Buton', 'Kabupaten'),
('7405', '74', 'Konawe Selatan', 'Kabupaten'),
('7406', '74', 'Bombana', 'Kabupaten'),
('7407', '74', 'Wakatobi', 'Kabupaten'),
('7408', '74', 'Kolaka Utara', 'Kabupaten'),
('7409', '74', 'Konawe Utara', 'Kabupaten'),
('7410', '74', 'Buton Utara', 'Kabupaten'),
...
('7472', '74', 'Bau Bau', 'Kota'),
('7501', '75', 'Gorontalo', 'Kabupaten'),
('7502', '75', 'Boalemo', 'Kabupaten'),
('7503', '75', 'Bone Bolango', 'Kabupaten'),
('7504', '75', 'Pahuwato', 'Kabupaten'),
('7505', '75', 'Gorontalo Utara', 'Kabupaten'),
('7571', '75', 'Gorontalo', 'Kota'),
('7601', '76', 'Pasangkayu (Mamuju Utara)', 'Kabupaten'),
('7602', '76', 'Mamuju', 'Kabupaten'),
('7603', '76', 'Mamasa', 'Kabupaten'),
('7604', '76', 'Polewali Mandar', 'Kabupaten'),
('7605', '76', 'Majene', 'Kabupaten'),
('7606', '76', 'Mamuju Tengah', 'Kabupaten'),
('8101', '81', 'Maluku Tengah', 'Kabupaten'),
('8102', '81', 'Maluku Tenggara', 'Kabupaten'),
('8103', '81', 'Kepulauan Tanimbar (Maluku Tenggara Barat)', 'Kabupaten'),
('8104', '81', 'Buru', 'Kabupaten'),
('8105', '81', 'Seram Bagian Timur', 'Kabupaten'),
('8106', '81', 'Seram Bagian Barat', 'Kabupaten'),
('8107', '81', 'Kepulauan Aru', 'Kabupaten'),
...
('8203', '82', 'Halmahera Utara', 'Kabupaten'),
('8204', '82', 'Halmahera Selatan', 'Kabupaten'),
('8205', '82', 'Kepulauan Sula', 'Kabupaten'),
...
('9103', '91', 'Jayapura', 'Kabupaten'),
('9105', '91', 'Kepulauan Yapen', 'Kabupaten'),
('9106', '91', 'Biak Numfor', 'Kabupaten'),
('9110', '91', 'Sarmi', 'Kabupaten'),
('9111', '91', 'Keerom', 'Kabupaten'),
('9115', '91', 'Waropen', 'Kabupaten'),
('9119', '91', 'Supiori', 'Kabupaten'),
('9120', '91', 'Mamberamo Raya', 'Kabupaten'),
('9171', '91', 'Jayapura', 'Kota'),
('9201', '92', 'Sorong', 'Kabupaten'),
('9202', '92', 'Manokwari', 'Kabupaten'),
('9203', '92', 'Fak Fak', 'Kabupaten'),
('9204', '92', 'Sorong Selatan', 'Kabupaten'),
('9205', '92', 'Raja Ampat', 'Kabupaten'),
('9206', '92', 'Teluk Bintuni', 'Kabupaten'),
('9207', '92', 'Teluk Wondama', 'Kabupaten'),
('9208', '92', 'Kaimana', 'Kabupaten'),
('9209', '92', 'Tambrauw', 'Kabupaten'),
('9210', '92', 'Maybrat', 'Kabupaten'),
('9211', '92', 'Manokwari Selatan', 'Kabupaten'),
('9212', '92', 'Pegunungan Arfak', 'Kabupaten'),
('9271', '92', 'Sorong', 'Kota'),
('9301', '93', 'Merauke', 'Kabupaten'),
('9302', '93', 'Boven Digoel', 'Kabupaten'),
('9303', '93', 'Mappi', 'Kabupaten'),
('9304', '93', 'Asmat', 'Kabupaten'),
('9401', '94', 'Nabire', 'Kabupaten'),
('9402', '94', 'Puncak Jaya', 'Kabupaten'),
('9403', '94', 'Paniai', 'Kabupaten'),
('9404', '94', 'Mimika', 'Kabupaten'),
('9405', '94', 'Puncak', 'Kabupaten'),
('9406', '94', 'Dogiyai', 'Kabupaten'),
('9407', '94', 'Intan Jaya', 'Kabupaten'),
('9408', '94', 'Deiyai', 'Kabupaten'),
('9501', '95', 'Jayawijaya', 'Kabupaten'),
('9502', '95', 'Pegunungan Bintang', 'Kabupaten'),
('9503', '95', 'Yahukimo', 'Kabupaten'),
('9504', '95', 'Tolikara', 'Kabupaten'),
('9505', '95', 'Mamberamo Tengah', 'Kabupaten'),
('9506', '95', 'Yalimo', 'Kabupaten'),
('9507', '95', 'Lanny Jaya', 'Kabupaten'),
('9508', '95', 'Nduga', 'Kabupaten');
...
CREATE TABLE `tb_kecamatan` (
  `id_kecamatan` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `id_kabupaten_kecamatan` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `tb_kecamatan` (`id_kecamatan`, `id_kabupaten_kecamatan`, `nama_kecamatan`) VALUES
('id', 'regency_id', 'name'),
...
CREATE TABLE `tb_propinsi` (
  `id_propinsi` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nama_propinsi` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Table structure for table `tmp_izin`
--

CREATE TABLE `tmp_izin` (
  `id` int NOT NULL,
  `npk` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `tanggal_mulai` date NOT NULL,
  `tanggal_akhir` date NOT NULL,
  `status_izin` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `keterangan_izin` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `nik_user` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
(1, 'admin', 'admin', 'Administrator', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'admin', '2025-10-16 14:46:07', '2025-10-16 14:46:07'),
(3, '1700024', '1700024', 'Ichu Yulianty, S.Hut, M.Th', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(6, '5750012', '5750012', 'Elliansi Esmaun', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(9, '7650033', '7650033', 'M.Fikri, S.Pd', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(14, '11870075', '11870075', 'Supardi', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(17, '15730001', '15730001', 'Amalia Septhyanda , S.Pd', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(19, '15910037', '15910037', 'Kristina Dewi Natalia, S.Pd', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(22, '16930033', '16930033', 'Desi Sintia Dewi Simanjuntak, S.Pd', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(23, '17760062', '17760062', 'Leluyani, M.Th ', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(28, '18850124', '18850124', 'Misyewin Bawi, S.Pd', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(29, '18850125', '18850125', 'Letty Kriszeni, M.Th', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(30, '18890141', '18890141', 'Sukartini , S.Pd', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(36, '18970009', '18970009', 'Fransisco Hendrik Putra , S.E', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(38, '19680002', '19680002', 'Norhidayah, S.Pd ', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(40, '19880023', '19880023', 'Ria Handayani, S.Pd', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(44, '20950021', '20950021', 'Dimas Dwi Nugroho, S.Psi', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(46, '21910007', '21910007', 'Martopo Yuwono, S.Pd', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(49, '21960012', '21960012', 'Ari Ratna sari, S.Pd', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(52, '21990009', '21990009', 'Tommy Bayu Susanto, S.Kom', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(53, '22000002', '22000002', 'Kurniah Amalia, S.PAK', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(58, '99730061', '99730061', 'M. Zuhdi Sakuri, S.Si', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(68, '24740003', '24740003', 'Kuril Sigi', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '2024-02-19 05:14:14', '2024-02-19 05:14:14'),
(72, '99000004', '99000004', 'Laili Hayati, S.Pd ', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '2024-04-04 06:19:07', '2024-04-04 06:19:07'),
(80, '252358', '252358', 'Adytya Wijayanto\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:00', '2024-07-11 02:00:00'),
(81, '252361', '252361', 'Aulia Ulfah\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:01', '2024-07-11 02:00:01'),
(82, '252362', '252362', 'Junia Andini Saputri\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:02', '2024-07-11 02:00:02'),
(83, '252363', '252363', 'Marsil\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:03', '2024-07-11 02:00:03'),
(84, '252364', '252364', 'Gloria Paulida\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:04', '2024-07-11 02:00:04'),
(85, '252365', '252365', 'Desti Flora Andrea\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:05', '2024-07-11 02:00:05'),
(86, '252367', '252367', 'Iskal Munasir\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:06', '2024-07-11 02:00:06'),
(88, '242341', '242341', 'Agata Vidia Calbie\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:08', '2024-07-11 02:00:08'),
(89, '242342', '242342', 'Andator Ady Putra\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:09', '2024-07-11 02:00:09'),
(90, '242343', '242343', 'Azis Maulana Saputra\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:10', '2024-07-11 02:00:10'),
(91, '242344', '242344', 'Richi Kasih Karuniani\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:11', '2024-07-11 02:00:11'),
(92, '242349', '242349', 'Priskila Novia\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:12', '2024-07-11 02:00:12'),
(93, '242350', '242350', 'Melisa\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:13', '2024-07-11 02:00:13'),
(94, '242352', '242352', 'Refli\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:14', '2024-07-11 02:00:14'),
(95, '242354', '242354', 'Nikita Felly Hirmandani\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:15', '2024-07-11 02:00:15'),
(96, '252366', '252366', 'Yehuda Ferdiansyah\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:16', '2024-07-11 02:00:16'),
(97, '242355', '242355', 'GIDEON ALFREDO ZHERAVINO PUADJOLE\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:17', '2024-07-11 02:00:17'),
(99, '232330', '232330', 'A. A Agus Saputra\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:19', '2024-07-11 02:00:19'),
(100, '232331', '232331', 'Billy Kristian \n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:20', '2024-07-11 02:00:20'),
(101, '232334', '232334', 'Hendri Saputra\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:21', '2024-07-11 02:00:21'),
(102, '232335', '232335', 'Juan Arnanda\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:22', '2024-07-11 02:00:22'),
(103, '232336', '232336', 'Maria Klaudia\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:23', '2024-07-11 02:00:23'),
(104, '232337', '232337', 'Nita Ayu\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:24', '2024-07-11 02:00:24'),
(105, '232338', '232338', 'Tribayu Yoyada\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:25', '2024-07-11 02:00:25'),
(107, '232314', '232314', 'Aprilliana\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:27', '2024-07-11 02:00:27'),
(108, '232319', '232319', 'Bella kristiana\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:28', '2024-07-11 02:00:28'),
(109, '232320', '232320', 'Cayla Lucia Ramadani\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:29', '2024-07-11 02:00:29'),
(110, '232321', '232321', 'Jekra Agustina Lehu\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:30', '2024-07-11 02:00:30'),
(111, '232322', '232322', 'Kandini\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:31', '2024-07-11 02:00:31'),
(112, '232323', '232323', 'Kalvin Binhar Yonatan\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:32', '2024-07-11 02:00:32'),
(113, '232324', '232324', 'Nova Elisa\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:33', '2024-07-11 02:00:33'),
(114, '232325', '232325', 'Risma \n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:34', '2024-07-11 02:00:34'),
(115, '232327', '232327', 'Winda\n', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'siswa', '2024-07-11 02:00:35', '2024-07-11 02:00:35'),
(669, 'piket', 'piket', 'Piket SMA Bethel', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'piket', '2025-12-22 17:17:36', '2025-12-22 17:17:36'),
(670, '990707', '990707', 'Satpam SMA Bethel', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'pegawai', '2025-12-21 17:19:34', '2025-12-21 17:19:34'),
(671, 'rfid', 'rfid', 'Admin Absen Kantor', '$2y$10$/IK7WOEf2mhNgnjOCQWZUeycV1R0nUwVqZBL4FHB1ehT4TIAkMubW', 'rfid', '2025-12-21 17:21:10', '2025-12-21 17:21:10');
...
--
-- Indexes for table `absen_harian_siswa`
--
ALTER TABLE `absen_harian_siswa`
  ADD PRIMARY KEY (`id_ahs`);

--
-- Indexes for table `absen_izin`
--
...
--
-- Indexes for table `absen_kelas_siswa`
--
...
ALTER TABLE `catatan_wali_kelas`
  ...
  ADD UNIQUE KEY `unique_catatan` (`id_jadwal_setting`,`id_siswa`),
  ADD KEY `idx_siswa` (`id_siswa`),
  ADD KEY `idx_jadwal_setting` (`id_jadwal_setting`);

--
-- Indexes for table `dar`
--
ALTER TABLE `dar`
...
--
-- Indexes for table `izin_keluar_jam_kerja`
--
ALTER TABLE `izin_keluar_jam_kerja`
  ADD PRIMARY KEY (`id_izin_keluar`);

--
-- Indexes for table `izin_mengajar`
--
ALTER TABLE `izin_mengajar`
  ADD PRIMARY KEY (`id_izin`);

--
-- Indexes for table `izin_mengajar_transaksi`
--
...
ALTER TABLE `nilai_pelajaran`
  ...
  ADD UNIQUE KEY `unique_nilai` (`id_jadwal_setting`,`id_siswa`,`id_pelajaran`),
  ADD KEY `idx_siswa` (`id_siswa`),
  ADD KEY `idx_pelajaran` (`id_pelajaran`),
  ADD KEY `idx_jadwal_setting` (`id_jadwal_setting`);
...
ALTER TABLE `nilai_sikap`
  ...
  ADD UNIQUE KEY `unique_sikap` (`id_jadwal_setting`,`id_siswa`),
  ADD KEY `idx_siswa` (`id_siswa`),
  ADD KEY `idx_jadwal_setting` (`id_jadwal_setting`);
...
ALTER TABLE `prestasi`
  ...
  ADD KEY `idx_siswa` (`id_siswa`),
  ADD KEY `idx_jadwal_setting` (`id_jadwal_setting`),
  ADD KEY `idx_jenis` (`jenis_prestasi`);

--
-- Indexes for table `send_wa`
--
ALTER TABLE `send_wa`
...
--
ALTER TABLE `absen_harian_siswa`
  MODIFY `id_ahs` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
-- AUTO_INCREMENT for table `absen_kelas_siswa`
--
ALTER TABLE `absen_kelas_siswa`
...
--
ALTER TABLE `catatan_wali_kelas`
  MODIFY `id_catatan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `ekstrakurikuler`
  MODIFY `id_ekstrakurikuler` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
-- AUTO_INCREMENT for table `izin_keluar_jam_kerja`
--
ALTER TABLE `izin_keluar_jam_kerja`
  MODIFY `id_izin_keluar` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `izin_mengajar`
--
ALTER TABLE `izin_mengajar`
  MODIFY `id_izin` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `izin_mengajar_transaksi`
--
ALTER TABLE `izin_mengajar_transaksi`
...
--
ALTER TABLE `jadwal_lengkap`
  MODIFY `id_jadwal_lengkap` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT for table `jadwal_setting`
--
ALTER TABLE `jadwal_setting`
  MODIFY `id_jadwal_setting` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `m_pelajaran`
  MODIFY `id_pelajaran` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=169;
...
--
ALTER TABLE `m_tahun_ajaran`
  MODIFY `id_tahun_ajaran` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `nilai_pelajaran`
--
ALTER TABLE `nilai_pelajaran`
  MODIFY `id_nilai_pelajaran` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;

--
-- AUTO_INCREMENT for table `nilai_sikap`
--
ALTER TABLE `nilai_sikap`
  MODIFY `id_nilai_sikap` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `pegawai`
  MODIFY `id_pegawai` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
...
--
ALTER TABLE `prestasi`
  MODIFY `id_prestasi` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `send_wa`
--
ALTER TABLE `send_wa`
  MODIFY `id_send_wa` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `siswa`
  MODIFY `id_siswa` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=762;

--
-- AUTO_INCREMENT for table `tmp_izin`
--
ALTER TABLE `tmp_izin`
...
--
ALTER TABLE `users`
  MODIFY `id_user` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=673;
COMMIT;
